<%@ Page Language="C#" MasterPageFile="~/METED/METED_Audit_MasterPage.master" AutoEventWireup="true"
    CodeFile="METED_Audit_Page16.aspx.cs" Inherits="METED_METED_Audit_Page16" Title="METED_Audit_Page16" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="DivPrint">
        ...
        <p style="text-align: center; padding-bottom: 0; font-size: 16px">
            <strong>Air Leakage Testing</strong></p>
        <p>
            ...
            Number of Occupants:<asp:TextBox ID="txt_NumberOccupants" runat="server" Style="border: none;
                ...
                width: 50px;" onkeyup="CalculateOccupant()"></asp:TextBox>
        ...
        <p>
            ...
            minutes to get CFM Natural for the Building (B)</p>
        <div class="newtable" style="border: 1px solid #000; height: auto;">
            ...
            <div>
                ...
                <asp:DropDownList ID="DDL_storyGrade" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0);
                    font-weight: normal; color: rgb(0, 0, 0); width: 180px;" onchange="fillAllAutomaticField();">
                ...
                4. Multiply by height corrected N Factor:<asp:TextBox ID="txt_CorrectedFactor" runat="server"
                    ...
                    color: rgb(0, 0, 0); width: 27px;"></asp:TextBox>
                <br />
                <br />
            </div>
            <div>
                <div class="margindiv">
                    ...
                    <div class="tableone" style="float: left; width: 147px;">
                        <p style="float: left; margin: right 8px;">
                            N Factor (online</br> completion)</p>
                        <asp:TextBox ID="txt_FactorOnline" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0);
                            font-weight: normal; color: rgb(0, 0, 0); width: 45px; margin-top: 20px;"></asp:TextBox>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            document.getElementById('Page16').classList.add("ui-selected");
        });
    </script>
