    ...
    <div id="DivPrint">
            ...
            <div class="newtable">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="5">
                    <tr>
                        ...
                        <td width="80" style="border: 0 !important;">
                        </td>
                        <td width="165">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="5"> -->
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txt_Line13_Install" runat="server" onkeyup="
                                ();" Style="width: 50px;
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txt_Line14_Install" runat="server" onkeyup="AddSpecialBulb();" Style="width: 50px;
                                border: none;"></asp:TextBox>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txt_Line15_Install" runat="server" onkeyup="AddSpecialBulb();" Style="width: 50px;
                                border: none;"></asp:TextBox>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txt_Line16_Install" runat="server" onkeyup="AddSpecialBulb();" Style="width: 50px;
                                border: none;"></asp:TextBox>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txt_Line17_Install" runat="server" onkeyup="AddSpecialBulb();" Style="width: 50px;
                                border: none;"></asp:TextBox>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txt_Line18_Install" runat="server" onkeyup="AddSpecialBulb();" Style="width: 50px;
                                border: none;"></asp:TextBox>
                        </td>
                        <td>
