<%@ Page Language="C#" MasterPageFile="~/METED/METED_Audit_MasterPage.master" AutoEventWireup="true"
    CodeFile="METED_Audit_Page17.aspx.cs" Inherits="METED_METED_Audit_Page17" Title="METED_Audit_Page17" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <tr>
                        ...
                        <td>
                            <table border="0" width="100%">
                                <tr>
                                    <td width="33%" align="top" style="vertical-align: 0; width: 262px; margin: 0px 0px 0px 48px;
                                        float: left;">
                                        <div class="newtable" style="border: 1px solid #000; padding: 5px; height: auto;
                                            width: 70%;">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            document.getElementById('Page17').classList.add("ui-selected");
        });
