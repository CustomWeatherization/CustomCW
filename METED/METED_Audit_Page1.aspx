            ...
            <p>
                <strong>
                    ...
                    <span id="Spn_RevisedDate" runat="server">Revised Date:
                        <%--1/13/15--%><%--2/24/15--%><%--7/30/15--%>12/01/15</span> </strong>
            </p>
        </div>
        <br />
        <div class="newtable">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                ...
                <tr>
                    <td>
                        ...
                        <asp:TextBox ID="txt_State" runat="server" value="" Style="border-bottom: solid 1px rgb(0, 0, 0);
                            font-weight: normal; color: rgb(0, 0, 0); border-left-style: none; border-left-color: inherit; border-left-width: medium; border-right-style: none; border-right-color: inherit; border-right-width: medium; border-top-style: none; border-top-color: inherit; border-top-width: medium;" Width="70px"></asp:TextBox>&nbsp;Zip Code
                        <asp:TextBox ID="txt_ZipCode" runat="server" value="" Style="border-bottom: solid 1px rgb(0, 0, 0);
                            font-weight: normal; color: rgb(0, 0, 0); border-left-style: none; border-left-color: inherit; border-left-width: medium; border-right-style: none; border-right-color: inherit; border-right-width: medium; border-top-style: none; border-top-color: inherit; border-top-width: medium;" Width="72px"></asp:TextBox>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        Account Number&nbsp; <asp:TextBox ID="txt_AccountNo" runat="server" value="" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0);
