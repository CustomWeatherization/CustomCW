<%@ Page Language="C#" MasterPageFile="~/METED/METED_Audit_MasterPage.master" AutoEventWireup="true"
    CodeFile="METED_Audit_Page19.aspx.cs" Inherits="METED_METED_Audit_Page19" Title="METED Audit Page19" %>
    ...
    <div id="DivPrint">
        <div class="newtable">
            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                ...
                <tr>
                    <td colspan="3">
                        ...
                        <asp:RadioButton ID="rdo_CombustionAppliances_Yes" runat="server" GroupName="tester" />
                        Yes
                        <asp:RadioButton ID="rdo_CombustionAppliances_No" runat="server" GroupName="tester" />
                        No
                    </td>
                </tr>
                <tr>
            ...
            <div class="newtable" style="border: 1px solid #000; padding: 2px; height: auto;">
                ...
                <asp:RadioButton ID="rdo_UnventedCombustionHeatingApp_Y" runat="server" GroupName="test" />
                Yes
                <asp:RadioButton ID="rdo_UnventedCombustionHeatingApp_N" runat="server" GroupName="test" />
                No
