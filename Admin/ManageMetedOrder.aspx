<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManageMetedOrder.aspx.cs"
    Inherits="Admin_ManageMetedOrder" %>
...

            {
                ...
                onDrop: function (table, row) {
                    ...
                    $.ajax({
                        ...
                        url: "ManageMetedOrder.aspx/GridViewReorders",
...
<body>
    <form id="form1" runat="server">
        <div>
            <div id="loading" style="position: absolute; width: 100%; height: 300%; padding-top: 250px; background: rgba(0, 0, 0, 0.54); z-index: 999; display: none; text-align: center;">
                <img src="../images/loading.gif" alt="Processing" style="margin-top: 60%;" />
            </div>
            <div>
                <div class="fix_div">
                    <!-- header -->
                        ...
                        <div class="rounded_corners" style="width: 100%;">
                            <asp:GridView ID="GridViewReorder" runat="server" Width="100%" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-CssClass="noselect" HeaderText="Description">
                                        <ItemTemplate>
                                            <%#Eval("Discription")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
