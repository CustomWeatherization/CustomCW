<%@ Page Language="C#" MasterPageFile="~/Admin/Admin_Master_Page.master" AutoEventWireup="true"
    CodeFile="AddAllThing.aspx.cs" Inherits="Admin_AddAllThing" Title="PPL All Thing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong> Max:</strong>
                    <asp:TextBox ID="txt_MaxLaborRate" runat="server" Style="border: 1px solid #ccc;
                        font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: black; border-radius: 5px;
                        padding: 8px; margin: 0; width: 100px;"></asp:TextBox>
    ...
    <table align="center">
            ...
            <td colspan="2">
                <table width="100%">
                 ...
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*"
                    InitialValue="Select Measure Type" ControlToValidate="ddlTypeMeasure" Display="Dynamic"
                    ValidationGroup="rfv"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txt_CPU" runat="server" Style="border: 1px solid #ccc; font-family: Arial, Helvetica, sans-serif;
                                font-size: 14px; color: black; border-radius: 5px; padding: 8px; margin: 0; width: 150px;"
                                MaxLength="40"></asp:TextBox>
                        </td>
                    </tr>
        ...
        <tr>
            <td colspan="2" align="center">
                <asp:Button ID="btnSave" runat="server" Text="Save" class="top_btn" Style="margin-left: 70px;" ValidationGroup="rfv"
    ...
    <div class="rounded_corners" style="width: 100%;">
        <asp:GridView ID="grdAllThing" runat="server" Width="100%" DataKeyNames="RowId" AllowPaging="true"
            ...
            OnRowCancelingEdit="grdAllThing_RowCancelingEdit" OnRowEditing="grdAllThing_RowEditing" OnRowDataBound="RowDataBound"
            ...
            <Columns>
               ...
               <%-- <asp:TemplateField HeaderText="S/C">
                 ...
                 <asp:TemplateField HeaderText="Type Of Measure">
                    <ItemTemplate>
                    <asp:Label ID="lblTypeMeasure" runat="server" Text='<%#Eval("TypeOfMeasure")%>'></asp:Label>
                    <%--    <%#Eval("TypeOfMeasure")%>--%>
                    </ItemTemplate>
                    <EditItemTemplate>
                    <asp:HiddenField ID="hdnprice" runat="server" Value='<%#Eval("TypeOfMeasure") %>' /> <%--selectedvalue='<%# Bind("TypeOfMeasure")%>'--%>
                     <asp:DropDownList ID="ddlTypeMeasure" runat="server" Width="90px" >
                     <asp:ListItem Text="Select" Value="Select">Select</asp:ListItem>
                  <asp:ListItem Text="H & S" Value="H & S">H & S</asp:ListItem>
                  <asp:ListItem Text="Other" Value="Other">Other</asp:ListItem>
                  <asp:ListItem Text="Repair" Value="Repair">Repair</asp:ListItem>
                  <asp:ListItem Text="Shell" Value="Shell">Shell</asp:ListItem>
                  </asp:DropDownList>
                ...
                <asp:TemplateField HeaderText="Liurp Code">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txt_G_liurpCode" runat="server" Text='<%#Eval("liurpCode")%>' Width="35px"></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Unit">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txt_G_unit" runat="server" Text='<%#Eval("unit")%>' Width="35px"></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Labor Rate">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txt_G_laborRate" runat="server" Text='<%#Eval("laborRate")%>' Width="40px"></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
