<%@ Page Title="Common Category" Language="C#" MasterPageFile="~/Admin/Admin_Master_Page.master" AutoEventWireup="true" CodeFile="CommonCategory.aspx.cs" Inherits="Admin_CommonCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <br />
    <br />
    <h1 align="center">Common Category Page</h1>
    <br />
    <table align="center">
        <tr>
            <td>
            ...
            <td>
                <asp:TextBox ID="txtCategory" runat="server" Style="border: 1px solid #ccc; font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: black; border-radius: 5px; padding: 8px; margin: 0; width: 300px;"
