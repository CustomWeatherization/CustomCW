<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManageCommonOrder.aspx.cs" Inherits="Admin_ManageCommonOrder" %>
...

            {
                ...
                onDrop: function (table, row) {
                    ...
                    $.ajax({
                        ...
                        url: "ManageCommonOrder.aspx/GridViewReorders",
...
<body>
    <form id="form1" runat="server">
        <div>
            <div id="loading" style="position: absolute; width: 100%; height: 100%; padding-top: 250px; background: rgba(0, 0, 0, 0.54); z-index: 999; display: none; text-align: center;">
