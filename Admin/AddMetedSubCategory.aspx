<%@ Page Language="C#" MasterPageFile="~/Admin/Admin_Master_Page.master" AutoEventWireup="true"
    CodeFile="AddMetedSubCategory.aspx.cs" Inherits="Admin_AddMetedSubCategory" Title="Subcategory Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table align="center">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtDiscription" runat="server" Style="border: 1px solid #ccc; font-family: Arial, Helvetica, sans-serif;
                    font-size: 14px; color: black; border-radius: 5px; padding: 8px; margin: 0; width: 300px;"
                    MaxLength="150"></asp:TextBox>
                <asp:RequiredFieldValidator ID="rfv_txtDiscription" runat="server" ErrorMessage="*"
                    Display="Dynamic" ControlToValidate="txtDiscription" ValidationGroup="rfv"></asp:RequiredFieldValidator>
                <%--  <ajaxToolkit:FilteredTextBoxExtender ID="Fltr_txtCategory" runat="server" TargetControlID="txtSubCategory"
                    FilterType="LowercaseLetters,UppercaseLetters,Custom" FilterMode="ValidChars"
                    ValidChars=" /.">
                </ajaxToolkit:FilteredTextBoxExtender>--%>
    ...
    <div style="float: right;">
     ...
     <div style="float: left;">
        <a href="ManageMetedOrder.aspx" target="_blank">Click here to Manage Subcategory Order</a>
    </div>
    <br />
        ...
        <asp:GridView ID="grdSubCategory" runat="server" Width="100%" DataKeyNames="SubCatId"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Description">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txt_G_Discription" runat="server" TextMode="MultiLine" Text='<%#Eval("Discription")%>'
                            Style="width: 95%;"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RFV_G_Discription" runat="server" ErrorMessage="*"
                            Display="Dynamic" ControlToValidate="txt_G_Discription" ValidationGroup="rfv_G"></asp:RequiredFieldValidator>
                    </EditItemTemplate>
                </asp:TemplateField>
