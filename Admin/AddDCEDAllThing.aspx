<%@ Page Title="DCED All Thing" Language="C#" MasterPageFile="~/Admin/Admin_Master_Page.master" AutoEventWireup="true" CodeFile="AddDCEDAllThing.aspx.cs" Inherits="Admin_AddDCEDAllThing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <br />
    <br />
    <h1 align="center">Add DCED All Thing</h1>
    <br />
        ...
        <asp:GridView ID="grdAllThing" runat="server" Width="100%" DataKeyNames="RowId" AllowPaging="true"
            ...
            <Columns>
                ...
                <%--  <asp:TemplateField HeaderText="Type Of Measure">
                    ...
                    <EditItemTemplate>
                    <asp:HiddenField ID="hdnprice" runat="server" Value='<%#Eval("TypeOfMeasure") %>' /> 
