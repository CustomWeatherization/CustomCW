<%@ Page Language="C#" MasterPageFile="~/Admin/Admin_Master_Page.master" AutoEventWireup="true"
    CodeFile="PPlZoneAllThing.aspx.cs" Inherits="Admin_PPlZoneAllThing" Title="PPlZoneAllThing" %>
            ...
            <td colspan="2">
                <table width="100%">
                    <tr>
                        ...
                        <td> <asp:DropDownList ID="ddlTypeMeasure" runat="server" Style="border: 1px solid #ccc; font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: black; border-radius: 5px; padding: 8px; margin: 0; width: 172px;">
        ...
        <tr>
            <td colspan="2" align="center">
                <asp:Button ID="btnSave" runat="server" Text="Save" class="top_btn" Style="margin-left: 70px;"
                    OnClick="btnSave_Click" ValidationGroup="rfv"/>
