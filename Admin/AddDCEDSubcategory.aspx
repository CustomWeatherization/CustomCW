<%@ Page Language="C#" MasterPageFile="~/Admin/Admin_Master_Page.master" AutoEventWireup="true" CodeFile="AddDCEDSubcategory.aspx.cs" Inherits="Admin_AddDCEDSubcategory" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="float: left;">
        <a href="ManageDCEDOrder.aspx" target="_blank">Click here to Manage Subcategory Order</a>
    </div>
    <br />
