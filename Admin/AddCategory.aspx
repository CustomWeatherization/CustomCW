<%@ Page Language="C#" MasterPageFile="~/Admin/Admin_Master_Page.master" AutoEventWireup="true"
    CodeFile="AddCategory.aspx.cs" Inherits="Admin_AddCategory" Title="Category Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="rounded_corners" style="width: 100%;">
        <asp:GridView ID="grdCategory" runat="server" Width="100%" DataKeyNames="CatID" AutoGenerateColumns="false"
            OnRowUpdating="grdCategory_RowUpdating" OnRowDeleting="grdCategory_RowDeleting" PageSize="10"
            AllowPaging="true" OnPageIndexChanging="grdCategory_PageIndexChanging" HeaderStyle-BackColor="#3AC0F2"
