<%@ Page Language="C#" MasterPageFile="~/Admin/Admin_Master_Page.master" AutoEventWireup="true"
    CodeFile="AddSubCategory.aspx.cs" Inherits="AddSubCategory" Title="Subcategory Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="float: left;">
        <a href="ManagePPLOrder.aspx" target="_blank">Click here to Manage Subcategory Order</a>
    </div>
    <br />
