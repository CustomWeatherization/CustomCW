<%@ Page Language="C#" MasterPageFile="~/Admin/Admin_Master_Page.master" AutoEventWireup="true" CodeFile="AddUGISubcategory.aspx.cs" Inherits="Admin_AddUGISubcategory" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="float: left;">
        <a href="ManageUGIOrder.aspx" target="_blank">Click here to Manage Subcategory Order</a>
    </div>
    <br />
