<%@ Page Language="C#" MasterPageFile="~/Admin/Admin_Master_Page.master" AutoEventWireup="true"
    CodeFile="MetedWarmPlusThings.aspx.cs" Inherits="Admin_MetedWarmPlusThings" Title="METEd(W+) All Thing" %>
        ...
        <asp:GridView ID="grdAllMetedThing" runat="server" Width="100%" DataKeyNames="RowId"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Location">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txt_G_Location" runat="server" Text='<%#Eval("Location")%>' Width="50px"></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Code">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txt_G_Code" runat="server" Text='<%#Eval("Code")%>' Width="50px"></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="THW">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txt_G_THW" runat="server" Text='<%#Eval("THW")%>' Width="50px"></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="TW">
                    <ItemTemplate>
                        <%#Eval("TW")%>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="txt_G_TW" runat="server" Text='<%#Eval("TW")%>' Width="50px"></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Cost">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txt_G_Cost" runat="server" Text='<%#Eval("Cost")%>' Width="50px"></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Labor">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txt_G_Labor" runat="server" Text='<%#Eval("Labor")%>' Width="50px"></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Material">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txt_G_Material" runat="server" Text='<%#Eval("Material")%>' Width="55px"></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
