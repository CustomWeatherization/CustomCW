...
function updateEvent(event, element) {
    //alert('upr wala ' + event.description);
    ...
    if (event.Status == true) {
        window.top.location.href = "http://localhost:60509/AddNewJob.aspx";
...
//    return text;
//}
function qTipText(start, end, Name, Phone, Address, JobType_, AuditorName, CrewCheifName, time, contactResult, Status, description) {
    var text;
   // var text1;
    if (Status == true) {
        text = "<b>Time:-</b>" + time + "<br/>" + "<b>ContactResult:-</b>" + contactResult + "<br/>" + "<b>Name:-</b>" + Name + "<br/>" + "<b>Phone:-</b>" + Phone + "<br/>" + "<b>Address:-</b>" + Address + "<br/>" + "<b>Job Type:-</b>" + JobType_ + "<br/>" + "<b>Auditor Name:-</b>" + AuditorName + "<br/>" + "<b>Crew CheifName:-</b>" + CrewCheifName + "<br/>";
        return text;
    }
    else {
    ...
    //    text = "<strong>Start:</strong> " + start.format("MM/DD/YYYY hh:mm T") + "<br/><strong>End:</strong><br/><br/>" + description + "<br/><strong>End:</strong><br/><br/>" + "<br/><strong>Name:</strong><br/><br/>" + desc1;
    //if (Status == true)
    //    return text;
    //else
    //    return false;
...
$(document).ready(function (Status) {
    ...
    $('#calendar').fullCalendar({
        ...
        eventRender: function (event, element) {
            element.qtip({
                content: {
                    text: qTipText(event.start, event.end, event.Name, event.Phone, event.Address, event.JobType_, event.AuditorName, event.CrewCheifName, event.time, event.contactResult, event.Status, event.description),
