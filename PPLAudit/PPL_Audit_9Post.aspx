<%@ Page Language="C#" MasterPageFile="~/PPLAudit/PPLMasterPage.master" AutoEventWireup="true"
    CodeFile="PPL_Audit_9Post.aspx.cs" Inherits="PPLAudit_PPL_Audit_9Post" Title="PPL Audit-9 Post" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="fontbold">
        <div id="DivPrint">
            <div class="bg_img" id="ViewIMG" runat="server" visible="true">
            </div>
            <h2 align="left">
                Combustion Appliances Post-Test</h2>
            <br />
            ...
            <table width="100%" cellspacing="0" cellpadding="2" border="1px">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <asp:TextBox ID="txt_WaterHeater_CO_AMB" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_WaterHeater_CO_CAZ" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_WaterHeater_BackDraft_WC" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_WaterHeater_BackDraft_NAT" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_WaterHeater_DarftEstablished_WC" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_WaterHeater_DarftEstablished_NAT" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_WaterHeater_DarftPressure_WC" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_WaterHeater_DarftPressure_NAT" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_WaterHeater_DarftPass_WC" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_WaterHeater_DarftPass_NAT" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_WaterHeater_UndilCOFlue" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_WaterHeater_GasLeackDet" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_WaterHeater_PrecentEff" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="center">
                            <asp:TextBox ID="txt_FurnaceBoiler_CO_AMB" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_FurnaceBoiler_CO_CAZ" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_FurnaceBoiler_BackDraft_WC" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_FurnaceBoiler_BackDraft_NAT" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_FurnaceBoiler_DraftEstablished_WC" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_FurnaceBoiler_DraftEstablished_NAT" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_FurnaceBoiler_DarftPressure_WC" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_FurnaceBoiler_DarftPressure_NAT" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_FurnaceBoiler_DarftPass_WC" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_FurnaceBoiler_DarftPass_NA" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_FurnaceBoiler_UndilCOFlue" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_FurnaceBoiler_GasLeackDet" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_FurnaceBoiler_PrecentEff" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="center">
                            <asp:TextBox ID="txt_Outher1_CO_AMB" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher1_CO_CAZ" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher1_BackDraft_WC" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher1_BackDraft_NAT" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher1_DarftEstablished_WC" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher1_DarftEstablished_NAT" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher1_DarftPressure_WC" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher1_DarftPressure_NAT" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher1_DarftPass_WC" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher1_DarftPass_NA" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher1_UndilCOFlue" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher1_GasLeackDet" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher1_PrecentEff" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="center">
                            <asp:TextBox ID="txt_Outher2_CO_AMB" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher2_CO_CAZ" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher2_BackDraft_WC" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher2_BackDraft_NAT" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher2_DarftEstablished_WC" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher2_DarftEstablished_NAT" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher2_DarftPressure_WC" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher2_DarftPressure_NAT" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher2_DarftPass_WC" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher2_DarftPass_NA" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher2_UndilCOFlue" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher2_GasLeackDet" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="txt_Outher2_PrecentEff" runat="server" Style="border-bottom: 1px #ccc solid;
                                border: none; font-weight: normal; color: rgb(0, 0, 0);" Width="39px"></asp:TextBox>
                            <%--width: 44px; width: 41px\9;--%>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" style="font-size: 12px">
                            ...
                            <asp:TextBox ID="txt_RearLeftBurner" runat="server" Style="border-bottom: solid 1px rgb(219, 219, 219);
                                font-weight: normal; color: rgb(0, 0, 0); height: 19px; border-left-style: none;
                                ...
                                border-top-color: inherit; border-top-width: medium;" Width="40px"></asp:TextBox><asp:RadioButton
                                    ID="rdo_RearLeftBurner1" runat="server" />&nbsp;&nbsp;<asp:RadioButton ID="rdo_RearLeftBurner2"
                                        runat="server" />Rear Right Burner<%--width:15%;--%>
                            <asp:TextBox ID="txt_RearRightBurner" runat="server" Style="border-bottom: solid 1px rgb(219, 219, 219);
                                font-weight: normal; color: rgb(0, 0, 0); height: 19px; border-left-style: none;
                                border-left-color: inherit; border-left-width: medium; border-right-style: none;
                                border-right-color: inherit; border-right-width: medium; border-top-style: none;
                                border-top-color: inherit; border-top-width: medium;" Width="40px"></asp:TextBox>
                            <%--width:15%;--%>
                        </td>
                        <td>
                            &nbsp;&nbsp; Dryer
                    ...
                    <tr>
                        <td align="left">
                            ...
                            <asp:TextBox ID="txt_OvenCODataCOAmbient" runat="server" Style="border-bottom: solid 1px rgb(219, 219, 219);
                                ...
                                border-left-color: inherit; border-left-width: medium; border-right-style: none;
                                border-right-color: inherit; border-right-width: medium; border-top-style: none;
                                border-top-color: inherit; border-top-width: medium;" Width="50px"></asp:TextBox><%--width:15%;--%>
                            CO At oven vent
                        ...
                        <td>
                            <h2 style="padding: 0;">
                                ...
                                <asp:TextBox ID="txt_CAZNat" runat="server" Style="border-bottom: solid 1px rgb(219, 219, 219);
                                    ...
                                    border-left-color: inherit; border-left-width: medium; border-right-style: none;
                                    border-right-color: inherit; border-right-width: medium; border-top-style: none;
                                    border-top-color: inherit; border-top-width: medium;" Width="80px"></asp:TextBox><%--width:15%;--%>
                                <span style="font-size: 12px;">W/C:</span>
                                <asp:TextBox ID="txt_CAZWC" runat="server" Style="border-bottom: solid 1px rgb(219, 219, 219);
                                    font-weight: normal; color: rgb(0, 0, 0); height: 19px; border-left-style: none;
                                    border-left-color: inherit; border-left-width: medium; border-right-style: none;
                                    border-right-color: inherit; border-right-width: medium; border-top-style: none;
                                    border-top-color: inherit; border-top-width: medium;" Width="80px"></asp:TextBox><%--width:s%;--%>
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:TextBox ID="txt_COAlarmsInstalledLocations" runat="server" Style="border-bottom: solid 1px rgb(219, 219, 219);
                                ...
                                border-left-color: inherit; border-left-width: medium; border-right-style: none;
                                border-right-color: inherit; border-right-width: medium; border-top-style: none;
                                border-top-color: inherit; border-top-width: medium; width: 25%;"></asp:TextBox><%--width:15%;--%>
                        </td>
                    </tr>
                    <tr>
                        <td>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            document.getElementById('Page9Post').classList.add("ui-selected");
        });
    ...
    <script type="text/javascript">
        document.getElementById("Page9Post").setAttribute("class", "ui-selected");   
    </script>
