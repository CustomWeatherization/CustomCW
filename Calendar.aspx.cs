...
public partial class Calendar : System.Web.UI.Page
{
    ...
    public static int addEvent(ImproperCalendarEvent improperEvent)
    {
        ...
        CalendarEvent cevent = new CalendarEvent()
        {
            ...
            Status = improperEvent.Status,
        contactResult = Convert.ToDateTime(improperEvent.start).ToString()
        };
        ...
        return -1; //return a negative number just to signify nothincg has been added
    }
