<%@ Page Language="C#" MasterPageFile="~/NewMETED/METED_Audit_MasterPage.master" AutoEventWireup="true"
    CodeFile="METED_Audit_Page7.aspx.cs" Inherits="METED_METED_Audit_Page6" Title="METED Audit Page6" %>
                ...
                <table width="99%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td align="left" width="55%">
                            Calculated Estimated Operating Cost/Month. (Optional Info): $:<asp:TextBox ID="txt_PriFrezer_OperatingCost" runat="server"
                    ...
                    <tr>
                        ...
                        <td>--%>
                            ...
                            <asp:CheckBox ID="chk_PriFrezer_FrostFree_No" runat="server" Text="No" onclick="PriFrezer_FrostFree(this.id)" /> <%--onclick="PriFrezer_FrostFree(this.id)"--%>
                        </td>
                    </tr>
                            </table>
                            <table width="99%" border="0" cellspacing="0" cellpadding="0">
            ...
            <div class="tab" style="border: 1px solid #000; padding: 10px; margin-top: 20px;">
                <table width="99%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td align="left" width="55%">
                            Calculated Estimated Operating Cost/Month. (Optional Info): $:<asp:TextBox ID="txt_SecoFrezer_OperatingCost" runat="server"
                                Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 55px; font-weight: normal;
                                color: rgb(0, 0, 0);"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2">--%>
                            ...
                            <asp:CheckBox ID="Chk_SecoFrezer_FrostFree_No" runat="server" Text="No" onclick="SecoFrezer_FrostFree(this.id)"/><%-- onclick="SecoFrezer_FrostFree(this.id)"--%>
                        </td>
                    </tr>
                            </table>
                            <table width="99%" border="0" cellspacing="0" cellpadding="0">
            ...
            <div class="tab" style="border: 1px solid #000; padding: 10px; margin-top: 20px;">
                <table width="99%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td align="left" width="55%">
                            Calculated Estimated Operating Cost/Month. (Optional Info): $:<asp:TextBox ID="txt_AddFrezer_OperatingCost"
                    ...
                    <tr>
                        ...
                        <td colspan="2">--%>
                            ...
                            <asp:CheckBox ID="Chk_AddFrezer_FrostFree_No" runat="server" Text="No" onclick="AddFrezer_FrostFree(this.id)"/><%-- onclick="AddFrezer_FrostFree(this.id)"--%>
                        </td>
                    </tr>
                    <table width="99%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
