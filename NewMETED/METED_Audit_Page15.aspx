<%@ Page Language="C#" MasterPageFile="~/NewMETED/METED_Audit_MasterPage.master" AutoEventWireup="true"
    CodeFile="METED_Audit_Page15.aspx.cs" Inherits="METED_METED_Audit_Page13" Title="METED_Audit_Page13" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="DivPrint">
        <div style="border:0px; width: 100%; height: auto;">
            <div ID="attic" runat="server" class="bgimg" style="border: 10px solid #000; width: 47%; float: left; min-height: 250px;">
             <strong>Attic</strong></div>
                 
            <div ID="Floor2" runat="server" class="bgimg" style="width: 47%; float: left;">
                <strong>2nd Fl</strong></div>
             
            <div class="clear">
            </div>
        </div>
        <div style="border:0px; width: 100%; height: auto; margin-bottom: 20px;">
            <div  ID="Basement" runat="server" class="bgimg"  style="border: 10px solid #000; width: 47%; float: left; min-height: 250px;">
                <strong>Basement</strong></div>
           
            <div  ID="Floor1" runat="server" class="bgimg"  style="width: 47%; float: left;">
