<%@ Page Language="C#" MasterPageFile="~/NewMETED/METED_Audit_MasterPage.master" AutoEventWireup="true"
    CodeFile="METED_Audit_Page6.aspx.cs" Inherits="METED_METED_Audit_Page5" Title="METED Audit Page5" %>
                ...
                <p align="center">
                    ...
                    <div class="tab" style="border: 1px solid #000; padding: 10px; margin-top: 20px;">
                        <table width="99%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td align="left" width="60%">
                                    Calculated Estimated Operating Cost/Month. (Optional Info): $:<asp:TextBox ID="txt_PriRefrigerator_OperatingCost" runat="server" Style="border: none;
                        ...
                        <table width="99%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                                    Is this unit eligible for <br />replacement?<asp:RadioButton ID="rdo_PriRefrigerator_Replacement_Yes" runat="server"
                        ...
                        <table width="99%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td align="left" width="55%">
                                    Calculated Estimated Operating Cost/Month. (Optional Info): $:<asp:TextBox ID="txt_SecoRefrigerator_OperatingCost"
                    ...
                    <div class="tab" style="border: 1px solid #000; padding: 10px; margin-top: 20px;">
                        <table width="99%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td align="left"  width="55%">
                                    Calculated Estimated Operating Cost/Month. (Optional Info): $:<asp:TextBox ID="txt_AddRefrigerator_OperatingCost"
                                        runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 52px;
                                        font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                </td>
                            </tr>
