<%@ Page Language="C#" MasterPageFile="~/NewMETED/METED_Audit_MasterPage.master" AutoEventWireup="true"
    CodeFile="METED_Audit_Page24.aspx.cs" Inherits="METED_METED_Audit_Page22" Title="METED_Audit_Page22" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(function() {
            document.getElementById('Page24').classList.add("ui-selected");
        });
