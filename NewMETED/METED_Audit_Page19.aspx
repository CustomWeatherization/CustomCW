<%@ Page Language="C#" MasterPageFile="~/NewMETED/METED_Audit_MasterPage.master" AutoEventWireup="true"
    CodeFile="METED_Audit_Page19.aspx.cs" Inherits="METED_METED_Audit_Page17" Title="METED_Audit_Page17" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <tr>
                        ...
                        <td>
                            <table border="0" width="100%">
                                <tr>
                                    <td width="33%" align="top" style="vertical-align: 0; width: 262px; margin: 0px 0px 0px 47px;
                                        float: left;">
                                        <div class="newtable" style="border: 1px solid #000; padding: 5px; height: auto;
                                            width: 70%;">
                                    ...
                                    <td align="right" valign="top" style="width: 160px; text-align: center; float:left;">
                                        <table border="1" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td colspan="9" align="left">
                                                    <%-- <div style="background: #eaeaea; padding: 4px; height: 120px;">--%>
                                                    <asp:TextBox ID="txt_Note1_17" runat="server" TextMode="MultiLine" Style="background: #eaeaea; height: 120px;"></asp:TextBox>
                                                    <%--</div>--%>
                                                </td>
                                            </tr>
                                        </table>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            document.getElementById('Page19').classList.add("ui-selected");
        });
