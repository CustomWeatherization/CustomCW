...
<body>
    ...
    <div id="fix_div" style="font-size: 14px; font-weight: normal; position: relative;">
        ...
        <div style="margin: 0 auto; width: 1000px; font-size: 14px; position: relative;"
            ...
            <!-- header -->
            <!-- end header -->
            <div style="border: 1px solid #B3B3B3; padding: 10px; width: 1020px; margin: 0px auto;">
                <br />
                <center>
            ...
            <%--Page 1 start--%>
            <section id="Form1">
               <div style="page-break-before: always; page-break-after: always; border: 1px solid #000000; width: 1020px; margin: 1px auto; position: relative;">
                 
        <div align="center" style="margin:5px 0px">
            <h2 style="margin:5px 0px">WARM Program Audit Form</h2>
        ...
        <div class="newtable">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                ...
                <tr>
                    <td colspan="2" style="padding-left: 5px;">
                        ...
                        <ajaxToolkit:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="txt_AuditDate">
                ...
                <tr>
                    ...
                    <td align="right">
                        ...
                        <asp:TextBox ID="txt_Date_Verifi" runat="server" value="" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0);
                            width: 30%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                        <ajaxToolkit:CalendarExtender ID="CalendarExtender4" runat="server" TargetControlID="txt_Date_Verifi">
                        </ajaxToolkit:CalendarExtender>
                    </td>
                </tr>
                <tr>
            ...
            <section id="Form2">
                      ...
                      <div style="page-break-after: always; border: 1px solid #000000; width: 1020px; margin: 0px auto; position: relative;">
                            <div class="newtable">
                                <!--newtable begin-->

                                <table width="100%" border="0" cellspacing="0" cellpadding="7">
                                    <tr>
                                        <td>6. Age of Occupants: Under Age 19:
                                        <asp:TextBox ID="txt_Occupants_under19" runat="server" value="" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 80px;"></asp:TextBox>
                                            Ages 19 to 62:
                                        <asp:TextBox ID="txt_Occupants_19_to_62" runat="server" value="" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 80px;"></asp:TextBox>
                                            Over 62:
                                        <asp:TextBox ID="txt_Occupants_Over62" runat="server" value="" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 80px;"></asp:TextBox>
                                        </td>
                                    </tr>
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                                <tr>
                                                    ...
                                                    <asp:CheckBox ID="chk_Structure_Other" runat="server" onclick="ChkBox_Structure(this.id)" />
                                                        99. Other
                                                    <asp:TextBox ID="txt_Structure_Other" runat="server" value="" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 80px;"></asp:TextBox>
                                                        <br />
                                    ...
                                    <tr id="tr_CunstructionType" runat="server">
                                        <td>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td style="width: 17%" valign="top">9. Construction Type:
                                                    </td>
                                                    <td>
                                    ...
                                    <tr>
                                        <td>9 A. Year Constructed:
                                        <asp:TextBox ID="txt_YearConstructed" runat="server" value="" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                        </td>
                                    </tr>

                                    <tr>
                                        <td>10. Size of Electrically Heated Area:
                                        <asp:TextBox ID="txt_ElectricallyHeatedArea" runat="server" value="" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                            sq. ft.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="8">
                                                <tr>
                                                    <td>11. Type of Air Conditioning:
                                                    </td>
                                                    <td>
                                    ...
                                    <asp:CheckBox ID="chk_AirConditioning_None" runat="server" onclick="ChkBox_AirConditioning(this.id)" />
                                                    ...
                                                    <br />
                                                        ...
                                                        99. Other
                                                    <asp:TextBox ID="txt_AirConditioning_Other" runat="server" value="" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 80px;"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td>12. Number of Window or Wall AC Units:
                                        <asp:TextBox ID="txt_WindoworWall" runat="server" value="" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <br />
                                    <tr>
                                        <td>13. Number of Rooms Routinely Air Conditioned:
                                        <asp:TextBox ID="txt_Rooms" runat="server" value="" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <br />
                                    <tr>
                                        <td>14. Size of Area Cooled:
                                        <asp:TextBox ID="txt_AreaCooled" runat="server" value="" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                            sq. ft.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="8">
                                                <tr>
                                                    <td style="width: 22%;" valign="top">15. Primary Heating Source:
                                                    </td>
                                                    <td>
                                                    ...
                                                    <asp:TextBox ID="txt_PrimaryHeatingSource_Other" runat="server" value="" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="8">
                                                <tr>
                                                    <td style="width: 22%;" valign="top">16. Type of Heating System:
                                                    </td>
                                                    <td>
                                                    ...
                                                    <asp:RadioButton ID="rdo_HeatingSystem_Other" runat="server" GroupName="HeatingSystem" />
                                                        99. Other (please describe)
                                                    <asp:TextBox ID="txt_HeatingSystem_Other" runat="server" value="" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="8">
                                                <tr>
                                                    <td style="width: 35%;" valign="top">17. What is the <u>Main</u> Source of Supplemental Heat?
                                                    </td>
                                                    <td>
                                        ...
                                        <br />
                                                        ...
                                                        99. Other (please describe)
                                                    <asp:TextBox ID="txt_SupplementalHeat_Other" runat="server" value="" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td>18. What is the Contribution of the <u>Main</u> Supplemental Heat Source to the Total Household
                                        Heating?
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <br />
                                            ...
                                            99. Other 
                                        <asp:TextBox ID="txt_HouseholdHeating_Other" runat="server" value="" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 330px;"></asp:TextBox>
                                            Location:
                                        <asp:TextBox ID="txt_Location" runat="server" value="" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 25%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr id="tr_electricSpaceHeater" runat="server">
                                        <td>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td style="width: 40%;" valign="top">18 A. Why are they using the electric space heater?
                                                    </td>
                                                    <td>
                                    ...
                                    <asp:CheckBox ID="chk_SpaceHeater_Other" runat="server" onclick="ChkBox_electricSpaceHeater(this.id)" />
                                                        &nbsp;Other
                                    <asp:TextBox ID="txt_SpaceHeater_Other" runat="server" value="" Style="border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); border-left-style: none; border-left-color: inherit; border-left-width: medium; border-right-style: none; border-right-color: inherit; border-right-width: medium; border-top-style: none; border-top-color: inherit; border-top-width: medium;" Width="253px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <br />
                                    <tr>
                                        <td>19. How many unblocked fireplaces are present in the customer's dwelling?<asp:TextBox
                                            ID="txt_unblockedFireplaces" runat="server" value="" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>(Enter
                                        actual number; enter "0" if none.)
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>20. Water Heater Fuel Type:
                                        ...
                                        <asp:RadioButton ID="rdo_FuelType_Other" runat="server" GroupName="FuelType" />
                                            99. Other
                                        <asp:TextBox ID="txt_FuelType_Other" runat="server" value="" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>21. Dryer Type:
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                ...
                <tr>
                    <td>
                        <asp:TextBox ID="txt_AreaDifficult" runat="server" Style="width: 96%; border: 1px solid #000000; height: 130px;"
                ...
                <tr>
                    <td>
                        <asp:TextBox ID="txt_ApplicationProb" runat="server" Style="width: 96%; border: 1px solid #000000; height: 130px;"
                            TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <asp:TextBox ID="txt_HighestEnergy" runat="server" Style="width: 96%; border: 1px solid #000000; height: 130px;"
                            TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                <br />
                ...
                <tr>
                    <td>
                        <asp:TextBox ID="txt_Expalain_HealthIssues1" runat="server" Style="width: 96%; border: 1px solid #000000; height: 130px;"
                            TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <asp:TextBox ID="txt_HealthIssue2" runat="server" Style="width: 96%; border: 1px solid #000000; height: 130px;"
                            TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <asp:TextBox ID="txt_GeneralComments" runat="server" Style="width: 96%; border: 1px solid #000000; height: 130px;"
                            TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
            </table>
            ...
            <section id="Form4">
                        ...
                        <div style="page-break-after: always; border: 1px solid #000000; width: 1020px; margin: 0 auto; position: relative;">
                           
                          
        <div align="center" style="margin:5px 0;">
            <h3 style="margin:5px 0">WARM Program Lighting</h3>
        ...
        <p style="margin:5px 0">
            ...
            as possible in each customer's home.</p>
            ...
            <div class="newtable">
                <!--newtable begin-->
                    ...
                    <b style="margin:5px 0">Note: All measures are required to be installed by the contractor.</b>
               
                <h4 align="center" style="text-decoration: underline; margin:5px 0;">CFL
                    Standard Bulbs</h4>
                <table width="100%" border="0" cellspacing="0" cellpadding="4" class="metdtable">
                    <tr>
                        <td width="106">
                            <%--LIURP or --%>Act 129
                        </td>
                ...
                <table width="100%" border="1" cellspacing="0" cellpadding="5"><%--class="metdtable"--%>
                    <tr>
                        <%-- <th>
                            LIURP
                        </th>--%>
                ...
                <h4 align="center" style="margin:5px 0">CFL
                    Specialty Bulbs</h4>
        ...
        <!-- form section -->
        <div class="newtable">
            <table id="tblled"  class="metdtable"  border="1" cellspacing="0" cellpadding="5">
                <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr style="text-align:center;">
                    <td width="75%" style="border:0; text-align:center">
                        ...
                        <table width="100%" border="1" cellspacing="0" cellpadding="5" style="text-align:left!important; border-right:0;">
                            <tr>
                                <td width="50%">
                                    ...
                                    <br />
                                    <asp:TextBox ID="txt_LedNightLight_Location4" runat="server" Style="border: none; border: solid 1px rgb(0, 0, 0); width: 92%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                <br />
                                </td>
                                <td style="border-right:0;">
                                    ...
                                    <br />
                                    <br />
                                    <asp:TextBox ID="txt_SmartPower_Location4" runat="server" Style="border: none; border: solid 1px rgb(0, 0, 0); width: 45%; font-weight: normal; color: rgb(0, 0, 0); "></asp:TextBox>
                    ...
                    <td style="border: 0 !important;" valign="top">
                        <table width="100%" cellspacing="0" cellpadding="5" id="tblmy" border="1">
                            <tr>
                            ...
                            <tr>
                             ...
                             <td style="border:0 !important;"># of Existing Alarms  less than 5 years old:</td>                                 
                            ...
                            <tr>
                                <td style="border:0 !important;">Total NEW Alarms installed # </td>
                                  <td style="border:0 !important;">  <asp:TextBox ID="txt_NewAlarms" runat="server" Style="width: 40px; text-align: center; border: none; border: solid 1px rgb(0, 0, 0);"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td style="border:0 !important;">Location of new:</td>
                                   <td style="border:0 !important;"> <asp:TextBox ID="txt_COAlarms_Location1" runat="server" Style="border: none; border: solid 1px rgb(0, 0, 0); width: 40px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                    </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr><td colspan="2" style="border:0 !important;"><asp:TextBox ID="txt_COAlarms_Location3" runat="server" Style="border: none; border: solid 1px rgb(0, 0, 0); width: 90%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox><br />
                                    </td></tr>
                                   <tr><td colspan="2" style="border:0 !important;"> <asp:TextBox ID="txt_COAlarms_Location4" runat="server" Style="border: none; border: solid 1px rgb(0, 0, 0); width: 90%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox><br />
                                    </td></tr>
                                    <tr><td colspan="2" style="border:0 !important;"><asp:TextBox ID="txt_COAlarms_Location5" runat="server" Style="border: none; border: solid 1px rgb(0, 0, 0); width: 90%; font-weight: normal; color: rgb(0, 0, 0); margin-bottom:14px;"></asp:TextBox>
                                </td></tr>
            ...
            <section id="Form5">
                        ...
                        <div style="page-break-after: always; border: 1px solid #000000; width: 1020px; margin: 0 auto; position: relative;">
                            ...
                            <div class="newtable">
                                <!--newtable begin-->
                                <h4 align="center">Refrigerators<%--/Freezers--%></h4>
                                    ...
                                    <tr>
                                        <td>
                                            <span id="spn_freezersUsed" runat="server">Number of freezers used:</span><asp:TextBox
                                                ID="txt_FreezersUsed" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 55px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr align="right">
                                        <td>Number of refrigerators used:<asp:TextBox ID="txt_RefrigeratorsUsed" runat="server"
                                            Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 55px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <%-- <tr align="right">
                                ...
                                database to determine annual usage.
                                </p>

                                <p>
                                    <b>Existing Refrigerator and Freezer Testing Data</b>
                                </p>
                                <p>
                                ...
                                <p>
                                    ...
                                    below. (Refer to chart on page 4-54 of the Policy and Procedures Manual)
                                    </p>
                                    <p>
                        ...
                        minute x 60 minutes = kWh per one hour</span>
                                    ...
                                    <p align="center">
                                        <table width="50%" border="1" cellspacing="0" cellpadding="0" style="margin: 0 auto; margin-top: -10px;">
                                            ...
                                            <tr>
                                                <td align="center">15 cu ft or less
                                                </td>
                                                <td align="center">.<%--104--%>08 kWh
                                                </td>
                                                <td align="center">15 cu ft
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center">16 - 19 cu ft
                                                </td>
                                                <td align="center">.<%--130--%>10 kWh
                                                </td>
                                                <td align="center">17 or 18 cu ft
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center">20 - 21 cu ft
                                                </td>
                                                <td align="center">.<%--140--%>11 kWh
                                                </td>
                                                <td align="center">21 cu ft
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center">22 cu ft or larger
                                                </td>
                                                <td align="center">.<%--200--%>12 kWh
                                                </td>
                                                <td align="center">20 - 25 cu ft
                                                </td>
                                            </tr>
                                        </table>
                                        <p align="center">
                                            <b>Ambient Air Temperature Immediately Surrounding the Refrigerator during Testing
                                        </b>
                                        </p>
                                        <table width="50%" border="1" cellspacing="0" cellpadding="2" style="margin: 0 auto; margin-top: -10px;">
                                            <tr>
                                                <td align="center">5 degrees (or more) hotter than average
                                                </td>
                                                <td align="center">0.88 factor
                                                </td>
                                                <td rowspan="3">*If not known by customer,<br />
                                                    use 70 degrees F
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center">Average annual temperature for room*
                                                </td>
                                                <td align="center">1.00 Factor
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center">5 degrees (or more) cooler than average
                                                </td>
                                                <td align="center">1.13 factor
                                                </td>
                                            </tr>
                                        </table>
                                        <div class="tab" style="border: 1px solid #000; padding: 3px; margin-top: 5px;">
                                            <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td>Location:<asp:TextBox ID="txt_PriRefrigerator_Location" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 150px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                    </td>
                                                    <td align="left">Calculated Estimated Operating
                                                    <br />
                                                        Cost/Month. (Optional Info): $:
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txt_PriRefrigerator_OperatingCost" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 55px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="4">Make:<asp:TextBox ID="txt_PriRefrigerator_Make" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                        <%--</td>
                                                <td>--%>&nbsp;&nbsp;
                                                    Model:<asp:TextBox ID="txt_PriRefrigerator_Model" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                        <%--</td>
                                                <td>--%>&nbsp;&nbsp;
                                                    Year:<asp:TextBox ID="txt_PriRefrigerator_Year" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                        <%--</td>
                                                <td>--%>&nbsp;&nbsp;
                                                    Size:<asp:TextBox ID="txt_PriRefrigerator_Size" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 40px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                        &nbsp;&nbsp;Type:
                                    <asp:CheckBox ID="Chk_PriRefrigerator_TopMount" runat="server" Text="Top Mount" onclick="PriRefrigeratorType(this.id)" />
                                                ...
                                                <tr>
                                                    <td colspan="4">Start Time:<asp:TextBox ID="txt_PriRefrigerator_StartTime" runat="server" Style="border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); border-left-style: none; border-left-color: inherit; border-left-width: medium; border-right-style: none; border-right-color: inherit; border-right-width: medium; border-top-style: none; border-top-color: inherit; border-top-width: medium;" Width="120px"></asp:TextBox>
                                                        <%--</td>
                                                <td>--%>&nbsp;&nbsp;
                                                    End Time:<asp:TextBox ID="txt_PriRefrigerator_EndTime" runat="server" Style="border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); border-left-style: none; border-left-color: inherit; border-left-width: medium; border-right-style: none; border-right-color: inherit; border-right-width: medium; border-top-style: none; border-top-color: inherit; border-top-width: medium;" Width="120px"></asp:TextBox>
                                                        <%--</td>
                                                <td colspan="2">--%>&nbsp;&nbsp;
                                                    Total Time Monitored:<asp:TextBox ID="txt_PriRefrigerator_TotalTime" runat="server"
                                                        Style="border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); border-left-style: none; border-left-color: inherit; border-left-width: medium; border-right-style: none; border-right-color: inherit; border-right-width: medium; border-top-style: none; border-top-color: inherit; border-top-width: medium;" Width="120px"></asp:TextBox>
                                                        &nbsp;&nbsp; Ice Maker?
                                    <asp:CheckBox ID="Chk_PriRefrigerator_IceMaker_Yes" runat="server" Text="Yes" onclick="PriRefrigerator_IceMaker(this.id)" />
                                                ...
                                                <tr>
                                                    <td>kWh Monitor Reading:<asp:TextBox ID="txt_PriRefrigerator_Monitor" runat="server"
                                                        Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                    </td>
                                                    <td>kWh conversion at one hour:<asp:TextBox ID="txt_PriRefrigerator_Conversion" runat="server"
                                                        Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                            <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td>Is this unit eligible for </br>replacement?<asp:RadioButton ID="rdo_PriRefrigerator_Replacement_Yes"
                                                    ...
                                                    <td>Temperature inside fresh food:<asp:TextBox ID="txt_PriRefrigerator_TemperatureFood"
                                                        runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>Room Temperature:<asp:TextBox
                                                            ID="txt_PriRefrigerator_TemperatureRoom" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>Temperature
                                                    inside freezer:<asp:TextBox ID="txt_PriRefrigerator_TemperatureFrezer" runat="server"
                                                        Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                            <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <asp:TextBox ID="txt_PriRefrigerator_ReplaceSize" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                        ...
                                        <div class="tab" style="border: 1px solid #000; padding: 3px; margin-top: 5px;">
                                            <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td>Location:<asp:TextBox ID="txt_SecoRefrigerator_Location" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 150px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                    </td>
                                                    <td align="left">Calculated Estimated Operating </br>Cost/Month. (Optional Info): $:<asp:TextBox ID="txt_SecoRefrigerator_OperatingCost"
                                                        runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 55px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="4">Make:<asp:TextBox ID="txt_SecoRefrigerator_Make" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                        <%--</td>
                                                <td>--%>&nbsp;&nbsp;
                                                    Model:<asp:TextBox ID="txt_SecoRefrigerator_Model" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                        <%--</td>
                                                <td>--%>&nbsp;&nbsp;
                                                    Year:<asp:TextBox ID="txt_SecoRefrigerator_Year" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                        <%--</td>
                                                <td>--%>&nbsp;&nbsp;
                                                    Size:<asp:TextBox ID="txt_SecoRefrigerator_Size" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 40px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                        &nbsp;&nbsp;Type:
                                    <asp:CheckBox ID="Chk_SecoRefrigerator_TopMount" runat="server" Text="Top Mount"
                                        onclick="SecRefrigeratorType(this.id)" />
                                                ...
                                                <tr>
                                                    <td colspan="4">Start Time:<asp:TextBox ID="txt_SecoRefrigerator_StartTime" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 120px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                        <%--</td>
                                                <td>--%>&nbsp;&nbsp;
                                                    End Time:<asp:TextBox ID="txt_SecoRefrigerator_EndTime" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 120px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                        <%--</td>
                                                <td colspan="2">--%>&nbsp;&nbsp;
                                                    Total Time Monitored:<asp:TextBox ID="txt_SecoRefrigerator_TotalTime" runat="server"
                                                        Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 120px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                        &nbsp;&nbsp; Ice Maker?
                                    <asp:CheckBox ID="Chk_SecoRefrigerator_IceMaker_Yes" runat="server" Text="Yes" onclick="SecRefrigerator_IceMaker(this.id)" />
                                                ...
                                                <tr>
                                                    <td>kWh Monitor Reading:<asp:TextBox ID="txt_SecoRefrigerator_Monitor" runat="server"
                                                        Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                    </td>
                                                    <td>kWh conversion at one hour:<asp:TextBox ID="txt_SecoRefrigerator_Conversion" runat="server"
                                                        Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                            <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td>Is this unit eligible </br> for replacement?<asp:RadioButton ID="rdo_SecoRefrigerator_Replacement_Yes"
                                                    ...
                                                    <td>Temperature inside fresh food:<asp:TextBox ID="txt_SecoRefrigerator_TemperatureFood"
                                                        runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>Room Temperature:<asp:TextBox
                                                            ID="txt_SecoRefrigerator_TemperatureRoom" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>Temperature
                                            ...
                                            <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td>
                                                        ...
                                                        Database Used? Replacement Size
                                                    <asp:TextBox ID="txt_SecoRefrigerator_ReplacementSize" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                        ...
                                        <div class="tab" style="border: 1px solid #000; padding: 3px; margin-top: 5px;">
                                            <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td>Location:<asp:TextBox ID="txt_AddRefrigerator_Location" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 150px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                    </td>
                                                    <td align="left">Calculated Estimated Operating </br>Cost/Month. (Optional Info): $:<asp:TextBox ID="txt_AddRefrigerator_OperatingCost"
                                                        runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 55px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="4">Make:<asp:TextBox ID="txt_AddRefrigerator_Make" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                        <%--</td>
                                                <td>--%>&nbsp;&nbsp;
                                                    Model:<asp:TextBox ID="txt_AddRefrigerator_Model" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                        <%--</td>
                                                <td>--%>&nbsp;&nbsp;
                                                    Year:<asp:TextBox ID="txt_AddRefrigerator_Year" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                        <%--</td>
                                                <td>--%>&nbsp;&nbsp;
                                                    Size:<asp:TextBox ID="txt_AddRefrigerator_Size" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 40px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                        &nbsp;&nbsp;Type:
                                    <asp:CheckBox ID="Chk_AddRefrigerator_TopMount" runat="server" Text="Top Mount" onclick="AddRefrigeratorType(this.id)" />
                                                ...
                                                <tr>
                                                    <td colspan="4">Start Time:<asp:TextBox ID="txt_AddRefrigerator_StartTime" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 120px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                        <%--</td>
                                                <td>--%>&nbsp;&nbsp;
                                                    End Time:<asp:TextBox ID="txt_AddRefrigerator_EndTime" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 120px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                        <%--</td>
                                                <td colspan="2">--%>&nbsp;&nbsp;
                                    ...
                                    <asp:CheckBox ID="Chk_AddRefrigerator_IceMaker_Yes" runat="server" Text="Yes" onclick="AddRefrigerator_IceMaker(this.id)" />
                                                ...
                                                <tr>
                                                    <td>kWh Monitor Reading:<asp:TextBox ID="txt_AddRefrigerator_Monitor" runat="server"
                                                        Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                    </td>
                                                    <td>kWh conversion at one hour:<asp:TextBox ID="txt_AddRefrigerator_Conversion" runat="server"
                                                        Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                            <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td>Is this unit eligible</br> for replacement?<asp:RadioButton ID="rdo_AddRefrigerator_Replacement_Yes"
                                                    ...
                                                    <td>Temperature inside fresh food:<asp:TextBox ID="txt_AddRefrigerator_TemperatureFood"
                                                        runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>Room Temperature:<asp:TextBox
                                                            ID="txt_AddRefrigerator_TemperatureRoom" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>Temperature
                                            ...
                                            <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    Replacement size
                                                    <asp:TextBox ID="txt_AddRefrigerator_ReplacementSize" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0);"
            ...
            <section id="Form6">
                        ...
                        <div style="page-break-after: always; border: 1px solid #000000; width: 1020px; margin: 0 auto; position: relative;">
                            <div class="newtable">
                                <h4 align="center">Freezers</h4>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td></td>
                                    </tr>
                                    <tr align="right" id="tr_freezersUsed" runat="server">
                                        <td>Number of freezers used:<asp:TextBox ID="txt_FreezersUsed6" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 55px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                                <table width="80%" border="1" cellspacing="0" cellpadding="5" style="margin: 0 auto;">
                                    ...
                                    <tr>
                                        <td align="center">Chest
                                        </td>
                                        <td align="center">Less than 8 cf
                                        </td>
                                        <td align="center">Greater than .064 kWh
                                        </td>
                                        <td align="center">Replace existing unit
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center">Chest
                                        </td>
                                        <td align="center">8.1 to 12.9 cf
                                        </td>
                                        <td align="center">Greater than .084 kWh
                                        </td>
                                        <td align="center">Replace existing unit
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align="center">13 to 15.5 cf
                                        </td>
                                        <td align="center">Greater than .103 kWh
                                        </td>
                                        <td align="center">Replace existing unit
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align="center">15.6 cf or larger
                                        </td>
                                        <td align="center">Greater than .154 kWh
                                        </td>
                                        <td align="center">Replace existing unit
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center">Upright
                                        </td>
                                        <td align="center">Less than 10 cf
                                        </td>
                                        <td align="center">Greater than .074 kWh
                                        </td>
                                        <td align="center">Replace existing unit
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align="center">10.1 to 12.9 cf
                                        </td>
                                        <td align="center">Greater than .103 kWh
                                        </td>
                                        <td align="center">Replace existing unit
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">Greater than .123 kWh
                                        </td>
                                        <td align="center">Replace existing unit
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align="center">15.6 or larger
                                        </td>
                                        <td align="center">Greater than .154 kWh
                                        </td>
                                        <td align="center">Replace existing unit
                                ...
                                <div class="tab" style="border: 1px solid #000; padding: 10px; margin-top: 20px;">
                                    <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            <td>Location:<asp:TextBox ID="txt_PriFrezer_Location" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 150px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                            </td>
                                            <td align="left">Calculated Estimated Operating<br />
                                                Cost/Month. (Optional Info): $:<asp:TextBox ID="txt_PriFrezer_OperatingCost" runat="server"
                                                    Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 55px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="4">Make:<asp:TextBox ID="txt_PriFrezer_Make" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                <%--</td>
                                            <td>--%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Model:<asp:TextBox ID="txt_PriFrezer_Model"
                                                runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                <%--   </td>
                                            <td>--%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Year:<asp:TextBox ID="txt_PriFrezer_Year"
                                                runat="server" Width="50px" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                <%--  </td>
                                            <td>--%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Size:<asp:TextBox ID="txt_PriFrezer_Size"
                                                runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        ...
                                        <tr>
                                            <td colspan="4">Start Time:<asp:TextBox ID="txt_PriFrezer_StartTime" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 150px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                <%--</td>
                                        <td>--%>
                                            End Time:<asp:TextBox ID="txt_PriFrezer_EndTime" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 150px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                <%--</td>
                                        <td colspan="2">--%>
                                            Total Time Monitored:<asp:TextBox ID="txt_PriFrezer_TotalTime" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 140px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                Frost Free?
                            <asp:CheckBox ID="chk_PriFrezer_FrostFree_Yes" runat="server" Text="Yes" onclick="PriFrezer_FrostFree(this.id)" />
                                        ...
                                        <tr>
                                            <td>kWh Monitor Reading:<asp:TextBox ID="txt_PriFrezer_Monitor" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                            </td>
                                            <td>kWh conversion at one hour:<asp:TextBox ID="txt_PriFrezer_Conversion" runat="server"
                                                Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                    <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td style="padding: 9px 0;">Is this unit eligible
                                            <br />
                                            ...
                                            <td style="padding: 9px 0;">
                                                <%--Temperature inside fresh food:--%><asp:TextBox ID="txt_PriFrezer_TemperatureFood"
                                                    runat="server" Visible="false" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                    ...
                                    <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>
                                                ...
                                                Database Used? Replacement Size:
                                            <asp:TextBox ID="txt_PriFrezer_ReplacementSize" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                ...
                                <div class="tab" style="border: 1px solid #000; padding: 10px; margin-top: 20px;">
                                    <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            <td>Location:<asp:TextBox ID="txt_SecoFrezer_Location" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 150px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                            </td>
                                            <td align="left">Calculated Estimated Operating<br />
                                        ...
                                        <tr>
                                            <td colspan="4">Make:<asp:TextBox ID="txt_SecoFrezer_Make" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                <%--</td>
                                        ...
                                        <tr>
                                            <td colspan="4">Start Time:<asp:TextBox ID="txt_SecoFrezer_StartTime" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 150px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                <%--</td>
                                        <td>--%>
                                            End Time:<asp:TextBox ID="txt_SecoFrezer_EndTime" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 150px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                <%--</td>
                                        <td colspan="2">--%>
                                            Total Time Monitored:<asp:TextBox ID="txt_SecoFrezer_TotalTime" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 140px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                Frost Free?
                            <asp:CheckBox ID="Chk_SecoFrezer_FrostFree_Yes" runat="server" Text="Yes" onclick="SecoFrezer_FrostFree(this.id)" />
                                        ...
                                        <tr>
                                            <td>kWh Monitor Reading:<asp:TextBox ID="txt_SecoFrezer_Monitor" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                            </td>
                                            <td>kWh conversion at one hour:<asp:TextBox ID="txt_SecoFrezer_Conversion" runat="server"
                                                Width="100px" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                    <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>
                                                ...
                                                Database Used? Replacement Size:
                                            <asp:TextBox ID="txt_SecoFrezer_ReplacementSize" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                ...
                                <div class="tab" style="border: 1px solid #000; padding: 10px; margin-top: 20px;">
                                    <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            <td>Location:<asp:TextBox ID="txt_AddFrezer_Location" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 150px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                            </td>
                                            <td align="left">Calculated Estimated Operating</br> Cost/Month. (Optional Info): $:<asp:TextBox ID="txt_AddFrezer_OperatingCost"
                                                runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 55px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="4">Make:<asp:TextBox ID="txt_AddFrezer_Make" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                <%--</td>
                                            <td>--%>
                                            Model:<asp:TextBox ID="txt_AddFrezer_Model" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                <%--</td>
                                            <td>--%>
                                            Year:<asp:TextBox ID="txt_AddFrezer_Year" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                <%--</td>
                                            <td>--%>
                                            Size:<asp:TextBox ID="txt_AddFrezer_Size" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        ...
                                        <tr>
                                            <td colspan="4">Start Time:<asp:TextBox ID="txt_AddFrezer_StartTime" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 150px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                <%--</td>
                                        <td>--%>
                                            End Time:<asp:TextBox ID="txt_AddFrezer_EndTime" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 150px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                <%--</td>
                                        <td colspan="2">--%>
                                            Total Time Monitored:<asp:TextBox ID="txt_AddFrezer_TotalTime" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 140px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                Frost Free?
                            <asp:CheckBox ID="Chk_AddFrezer_FrostFree_Yes" runat="server" Text="Yes" onclick="AddFrezer_FrostFree(this.id)" />
                                        ...
                                        <tr>
                                            <td>kWh Monitor Reading:<asp:TextBox ID="txt_AddFrezer_Monitor" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                            </td>
                                            <td>kWh conversion at one hour:<asp:TextBox ID="txt_AddFrezer_Conversion" runat="server"
                                                Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 100px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                    <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td style="padding: 9px 0;">Is this unit eligible</br> for replacement?<asp:RadioButton ID="rdo_AddFrezer_Replacement_Yes"
                                            ...
                                            <td style="padding: 9px 0;">
                                                <%--Temperature inside fresh food:--%><asp:TextBox ID="txt_AddFrezer_TemperatureFood"
                                                    runat="server" Visible="false" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                Room Temperature:<asp:TextBox ID="txt_AddFrezer_TemperatureRoom" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                ...
                <tr style="margin-top: 5px; float: left;">
                    <td>
                        ...
                        <asp:TextBox ID="txt_Temperature_Other" runat="server" Visible="false" Style="border: none;
                            border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0);
                            font-size: 11px; text-align: left; -webkit-width: 20%; !important; -moz-width: 35%; !important; width: 10%; !important; /* target ie8 & ie9 only */width: 10%; !important; /* ie 6 */width: 10%; !important; /* ie 8-9 */"></asp:TextBox>
                    </td>
                </tr>
            </table>
            <div style="width: 100%;">
        ...
        <div style="width: 100%;">
            ...
            <p style="float: left; width: 80% !important;">
                <asp:TextBox ID="txt_Commentform7" runat="server" TextMode="MultiLine" Width="95%" Height="100px"></asp:TextBox>
            </p>
        </div>
         </div>
    </div>
            ...
            <section id="Form8">    
                  ...
                  <section id="Form8">
                      <div style="page-break-after: always; border: 1px solid #000000; width: 1020px; margin: 0 auto; position: relative;">
                            ...
                            <br />
                            <p align="left">
                                <b>Electric Water Heating Assessment</b>
                            </p>
                            ...
                            <asp:RadioButton ID="rdo_WaterHeaterFuel_Other" runat="server" GroupName="WaterHeaterFuel" />
                                99. Other
                            <asp:TextBox ID="txt_WaterHeaterFuel_Other" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); font-size: 14px; text-align: left; -webkit-width: 5%; !important; -moz-width: 25%; !important; width: 5%; !important; width: 5%; !important; width: 5%; !important;"
                                runat="server"></asp:TextBox>
                                <br />
                            </p>
                            <br />
                            <div class="tab" style="border: 1px solid #000; float: left; width: 99%; margin-top: 0px; margin-bottom: 20px;">
                                ...
                                <table width="55%" border="0" cellspacing="1" cellpadding="1" align="left">
                                    <tr>
                                        <td colspan="2">Is the water heater leaking?
                                    ...
                                    <tr>
                                        <td colspan="2">Is the water heater rusted/corroded?
                                    ...
                                    <tr>
                                        <td colspan="2">Are the element(s) bad?
                                    ...
                                    <tr>
                                        <td colspan="2">Is the unit rated R8 or less?
                                    ...
                                    <tr>
                                        <td style="width: 60%;">Will water heater be replaced?<asp:RadioButton ID="rdo_WaterHeaterReplace_Yes" runat="server"
                                            GroupName="WaterHeaterReplace" />
                                            Yes
                                        <asp:RadioButton ID="rdo_WaterHeaterReplace_No" runat="server" GroupName="WaterHeaterReplace" />
                                            No
                                        </td>
                                        <td>Energy Factor:<asp:TextBox ID="txtEnergyFctr" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); font-size: 11px; text-align: left; -webkit-width: 43%; !important; -moz-width: 43%; !important; width: 43%; !important; width: 43%; !important; width: 43%; !important;"></asp:TextBox><%--Width="50px"--%>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: left;">Existing Water Heater size:&nbsp;
                                        <asp:TextBox ID="txt_ExistingWaterHeaterSize" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); font-size: 11px; text-align: left; -webkit-width: 80px; !important; -moz-width: 80px; !important; width: 80px; !important; width: 80px; !important; width: 80px; !important;"></asp:TextBox><%--Width="50px"--%>
                                        </td>
                                        <td style="text-align: left;">Replacement size:
                                        <asp:TextBox ID="txt_WaterHeaterReplaceSize" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); font-size: 11px; text-align: left; -webkit-width: 30%; !important; -moz-width: 30%; !important; width: 30%; !important; width: 30%; !important; width: 30%; !important;"></asp:TextBox><%--Width="50px"--%>
                                        </td>
                                    </tr>
                                </table>
                                <table width="40%" border="1" cellspacing="0" cellpadding="0" align="right" style="margin-right: 11px;">
                                    <tr>
                                        <td style="width: 60%;">Are you going to:
                                        <br />
                                        </td>
                                        <td style="width: 15%;">Yes
                                        <br />
                                        </td>
                                        <td style="width: 15%;">No
                                        <br />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Replace or add expansion tank:
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Add/replace pressure relief valve
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Add/replace pressure relief pipe
                                        </td>
                                        <td>
                                ...
                                <table width="100%" border="0" cellspacing="2" cellpadding="2" align="right" style="margin-top: 10px;">
                                    <tr>
                                        <td>Did you change the temperature?
                                    ...
                                    <tr>
                                        <td>Test location:
                                        <asp:TextBox ID="txt_TstLocation" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 200px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                            Existing Temp:
                                        <asp:TextBox ID="txt_ExistingTemp" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                            Adjusted Temp:
                                        <asp:TextBox ID="txt_AdjustTemp" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>&nbsp;&nbsp;(No
                                    ...
                                    <tr>
                                        <td>
                                            <table>
                                                <tr>
                                                    <td>Are you wrapping water pipes?
                                                    ...
                                                    <td>If so, # of linear ft for hot water:
                                                    <asp:TextBox ID="txt_Linear_FT" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                    ...
                                                    <asp:TextBox ID="page8_txt_Location" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 23%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    <td>If so, # of linear ft for cold water:
                                                    <asp:TextBox ID="txt_Linear_ColdFt" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                    ...
                                                    <asp:TextBox ID="txtLocationColdFT" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 23%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td>Comments:
                                        <asp:TextBox ID="page8_txt_Comments" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 90%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <br />
                                    <tr>
                                        <td>Are there any other hot water leaks?
                                        ...
                                        <asp:RadioButton ID="rdo_HotWaterLeaks_No" runat="server" GroupName="HotWaterLeaks" />
                                            No If yes, where?
                                        <asp:TextBox ID="txt_HotWaterLeaksYes_Comment" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 38%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <br />
                                    <tr>
                                        <td>Are you going to repair leaks?
                                        ...
                                        <asp:RadioButton ID="rdo_RepairLeaks_No" runat="server" GroupName="RepairLeaks" />
                                            No If yes, where?
                                        <asp:TextBox ID="txt_RepairLeaks_Yes_Comment" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 42%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <table width="100%" border="0" cellspacing="2" cellpadding="2" align="left" style="margin-top: 7px;">
                                ...
                                <tr>
                                    <td align="left">Are you installing faucet aerators?<asp:RadioButton ID="rdoInstalFaucetYes" runat="server"
                                        GroupName="Faucet" />Yes<asp:RadioButton ID="rdoInstalFaucetNo" runat="server" GroupName="Faucet" />No
                                    </td>
                                    <td align="left">If so, which?
                                    </td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    ...
                                    <td width="20%"># installed?<asp:TextBox ID="txtBathAerator" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                    </td>
                                    <td width="30%">Location:<asp:TextBox ID="txtBathLocation" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 150px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                                    ...
                                    <td># installed?<asp:TextBox ID="txtKitchenAerator" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                    </td>
                                    <td width="30%">Location:<asp:TextBox ID="txtKitchenLocation" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 150px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr align="left">
                                    <td width="40%">Are you installing a shower head?
                                ...
                                <tr>
                                    ...
                                    <td># installed?<asp:TextBox ID="txtSwivel" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                    </td>
                                    <td width="30%">Location:<asp:TextBox ID="txtSwivelLocation" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 150px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                                    ...
                                    <td># installed?<asp:TextBox ID="txtShutoff" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                    </td>
                                    <td width="30%">Location:<asp:TextBox ID="txtShutoffLocation" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 150px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                                    ...
                                    <td># installed?<asp:TextBox ID="txtWOshutoff" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                    </td>
                                    <td width="30%">Location:<asp:TextBox ID="txtWOshutoffLocation" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 150px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                                    ...
                                    <td># installed?<asp:TextBox ID="txtHandheld" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 50px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                    </td>
                                    <td width="30%">Location:<asp:TextBox ID="txtHandheldLocation" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 150px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                    </td>
                                </tr>
                                <br />
                                <tr>
                                    <td colspan="4">Would a GFX System work? Shower is used at least 15 minutes per day;basement drain
                                    ...
                                    available on the drain stack;drain pipe is at least 3" in diameter:<asp:RadioButton
                                        ...
                                        <div align="left" style="font-size: 0.9em;">
                                            If yes,how far is the drain pipe from the cold water supply?<asp:TextBox ID="txtColdWatrSupply"
                                                runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); font-size: 11px; text-align: left; -webkit-width: 6%; !important; -moz-width: 6%; !important; width: 3%; !important; width: 6%; !important; width: 6%; !important;"></asp:TextBox><%--Width="20px"--%>
                                        How far is the drain pipe from the water heater?<asp:TextBox ID="txtWaterHeater"
                                            runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 20px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>&nbsp;Installing GFX?<asp:RadioButton
                            ...
                            <table width="100%" border="0" cellspacing="0">
                                <tr>
                                    <td style="display: none;">Is customer on the time-of-day (TOD) rate?
                                ...
                                <tr>
                                    <td style="display: none;">If yes, is customer saving on this rate?
                                ...
                                <tr>
                                    <td style="display: none;">Does customer's lifestyle suit the rate change?
                                    <br />
                                ...
                                <tr style="display: none;">
                                    <td>Is customer going to switch to the TOD rate?
                                ...
                                <tr>
                                    <td>Does the customer have a water heater timer?
                                ...
                                <tr>
                                    <td>if yes, are you recommending removal
                    ...
                    <asp:CheckBox ID="rdo_TimerInstalled_No" runat="server" onclick="ChkBox_TimerInstalled(this.id)" />
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px;">
                                            <tr>
                                                <td valign="top" style="width: 15%;">Comments: &nbsp; &nbsp;
                                                </td>
                                                <td>
            ...
            <section id="Form9">
                        ...
                        <div style="page-break-after: always; border: 1px solid #000000; width: 1020px; margin: 0 auto; position: relative;">
                            ...
                            <table width="100%" border="0" cellspacing="6" cellpadding="15">
                                <tr>
                                    <td style="float: left; margin-left: -10px;">Is the customer a candidate(currently has an electric resistance water heater) for
                        ...
                        value="rdo_ThermostatAccurate_No" />--%><asp:RadioButton ID="rdo_WaterHeaterHPWH_No"
                            runat="server" GroupName="WaterHeaterHPWH" />
                                ...
                                <tr>
                                    <td style="float: left; margin-left: -10px;">Homeowner? &nbsp; &nbsp;
                        ...
                        value="rdo_InspectAcoil_No" />--%><asp:RadioButton ID="rdo_LessThenSix_No" runat="server"
                            GroupName="LessThenSix" />
                                ...
                                <tr>
                                    <td>Does the home have a basement area,where the HPWH would be located,that is at least
                        ...
                        value="rdo_CleaningRecommended_No" />--%><asp:RadioButton ID="rdo_NoDirtFloor_No"
                            runat="server" GroupName="NoDirtFloor" />
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="10">
                                            <tr>
                                                <td>Can you install the HPWH in an unconfined space that is at least 10' by 10' by 7'
                                ...
                                <tr>
                                    <td>Is there adequate space to bring the HPWH into the home, down the stairs, along
                                    railings, etc.?
                        ...
                        value="rdo_CoilsCleaned_No" />--%><asp:RadioButton ID="rdo_StairsAlongRailing_No"
                            runat="server" GroupName="StairsAlongRailing" />
                                ...
                                <tr>
                                    <td>Can you install the HPWH near an existing drain or line/pump that is no higher than
                        ...
                        value="rdo_CoilsCleaned_No" />--%><asp:RadioButton ID="rdo_ExistingDrain_No" runat="server"
                            GroupName="ExistingDrain" />
                                ...
                                <tr>
                                    <td>Are the home's plumbing and electrical systems in good shape ?
                                    <%--<input id="ctl00_ContentPlaceHolder1_rdo_CoilsCleaned_Yes" type="radio" name="ctl00$ContentPlaceHolder1$CoilsCleaned"
                        ...
                        value="rdo_CoilsCleaned_No" />--%><asp:RadioButton ID="rdo_GoodShape_No" runat="server"
                            GroupName="GoodShape" />
                                ...
                                <tr>
                                    <td>Is the customer willing and able to adjust the HPWH panel or maintain consistent
                                    usage habits?
                                    <%--<input id="ctl00_ContentPlaceHolder1_rdo_CoilsCleaned_Yes" type="radio" name="ctl00$ContentPlaceHolder1$CoilsCleaned"
                        ...
                        value="rdo_CoilsCleaned_No" />--%><asp:RadioButton ID="rdo_UsageHabits_No" runat="server"
                            GroupName="UsageHabits" />
                                ...
                                <tr>
                                    <td>Does the customer understand there is noise and cold air output associated with
                                    a HPWH ?
                                    <%--<input id="ctl00_ContentPlaceHolder1_rdo_CoilsCleaned_Yes" type="radio" name="ctl00$ContentPlaceHolder1$CoilsCleaned"
                        ...
                        value="rdo_CoilsCleaned_No" />--%><asp:RadioButton ID="rdo_AssociatedWithHPWH_No"
                            runat="server" GroupName="AssociatedWithHPWH" />
                                ...
                                <tr>
                                    <td>Does the customer agree to the installation of the system and to regularly clean
                                    the HPWH filter?
                                    <%--<input id="ctl00_ContentPlaceHolder1_rdo_CoilsCleaned_Yes" type="radio" name="ctl00$ContentPlaceHolder1$CoilsCleaned"
                        ...
                        value="rdo_CoilsCleaned_No" />--%><asp:RadioButton ID="rdo_CleanHPWHFilter_No" runat="server"
                            GroupName="CleanHPWHFilter" />
                                ...
                                <tr>
                                    <td>Is a HPWH recommended, and will it be installed ?
                                    <%--<input id="ctl00_ContentPlaceHolder1_rdo_CoilsCleaned_Yes" type="radio" name="ctl00$ContentPlaceHolder1$CoilsCleaned"
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="12" style="margin-top: 10px;">
                                            <tr>
                                                <td valign="top" style="width: 10%;">Comments: &nbsp; &nbsp;
                                                </td>
                                                <td>
                                                    <%--<textarea name="" cols="" rows="" style="height: 150px; width: 97%;"></textarea>--%>
                                                    <asp:TextBox ID="page9_txt_Comment" runat="server" TextMode="MultiLine" Style="height: 150px; width: 97%;"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <tr>
                                        <td width="75%">
                                            ...
                                            <%--<input name="" type="text" id="" class="txt_city" />--%><asp:TextBox ID="txt_Signature"
                                                Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 400px;"
                                                runat="server"></asp:TextBox>
                                        </td>
                                        <td width="20%">
                                            <strong>Date</strong>
                                            <%--<input name="" type="text" id="" class="txt_city" />--%><asp:TextBox ID="txt_Date"
                                                Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"
                                                runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
            ...
            <section id="Form10">
                        ...
                        <div style="page-break-after: always; border: 1px solid #000000; width: 1020px; margin: 0 auto; position: relative;">
                            <table border="0" cellpadding="10" cellspacing="10" width="100%">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox ID="txt_SummerSeasonalUse" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                        <strong>kWh</strong>
                                    </td>
                                </tr>
                            </table>
                            ...
                            and/or shell measures <strong style="padding-left: 1px;">if related to cooling.</strong>
                                <br />
                                <div class="text_only" style="font-size: 16.5px;">
                                    <strong>Window Film:</strong>Are there any windows on the west,south and east that
                                are not shaded in the summer during the hours of 9AM and 4PM?<asp:RadioButton ID="rdo_WindowFilm_Yes" runat="server" GroupName="WindowFilm" />
                                    Yes
                            ...
                            <asp:TextBox ID="txt_WindowFilmNeeded" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 10%;"></asp:TextBox>
                                # and location of west facing windows to receive film:
                            <asp:TextBox ID="txt_West_ReceiveFilm" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 10%;"></asp:TextBox>
                                <br />
                                # and location of south facing windows to receive film:
                            <asp:TextBox ID="txt_South_ReceiveFilm" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 10%;"></asp:TextBox>
                                # and location of east facing windows to receive film:
                            <asp:TextBox ID="txt_East_ReceiveFilm" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 10%;"></asp:TextBox>
                                <br />
                            ...
                            <asp:TextBox ID="txt_FootageOfRoof" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                <br />
                            ...
                            <asp:RadioButton ID="rdo_ReduceACUse_No" runat="server" GroupName="ReduceACUse" />
                                No &nbsp; &nbsp; Will install:
                            <asp:TextBox ID="txt_Will_Install" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 220px"></asp:TextBox>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px;">
                                    <tr>
                                        <td valign="top" style="width: 15%;">Comments: &nbsp; &nbsp;
                                        </td>
                            ...
                            <div style="border: 1px solid #000; width: 100%;">
                                <table width="100%" border="1" cellspacing="3" cellpadding="3" align="center">
                                    <tr>
                                        ...
                                        <th>EER = <u>BTU/hr Watts</u>
                                        </th>
                                        <th>Replace AC?
                                        </th>
                                        <th>Current Size BTU/hr
                                        </th>
                                        <th>Current Location
                                        </th>
                                        <th>New Size BTU/hr
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                    <tr>
                                        <td width="20%">What are the customer's window AC thermostat use habits?
                                        </td>
                                        <td>
                            ...
                            <asp:TextBox ID="txt_AC_ReplaceUnit" runat="server" Style="border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); border-left-style: none; border-left-color: inherit; border-left-width: medium; border-right-style: none; border-right-color: inherit; border-right-width: medium; border-top-style: none; border-top-color: inherit; border-top-width: medium;" Width="70px"></asp:TextBox>&nbsp;&nbsp;&nbsp;<!--New Task--><span id="tr_NewestACUnit" runat="server">Manufactured year for newest room AC unit
                                present(only if insulation is installed):
                                <asp:TextBox ID="txt_NewestACUnit" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 46px;"></asp:TextBox>
                                </span>
                                <!--End Task-->
                            </div>
                            ...
                            <asp:TextBox ID="txt_CustomerACThermostatUse" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 60%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                <br />
                            ...
                            <asp:RadioButton ID="rdo_ThermostatAccurate_IfNot" runat="server" GroupName="ThermostatAccurate" />
                                If not, why?
                            <asp:TextBox ID="txt_ThermostatAccurate_IfNot" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 54%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                <br />
                            ...
                            <br />
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td style="width: 25%;">Can you visually inspect the A-coil?
                                        </td>
                                        <td style="width: 11%;">
                                        ...
                                        <td style="width: 15%;">If yes, is cleaning<br />
                                            recommended?
                                        </td>
                                        <td style="width: 11%;">
                                        ...
                                        <td style="width: 13%;">If yes, cleaning<br />
                                            performed by:
                                        </td>
                                        <td style="width: 25%;">
                                    ...
                                    <tr>
                                        <td colspan="2">If visually unable to inspect A-coil, does usage
                                        <br />
                                        ...
                                        <td>If yes, was 3rd party contractor contacted?
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td colspan="6">If clean and tune recommended, why?
                                        <asp:TextBox ID="txt_CleanTuneRecommended" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 71%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <%-- <tr>
                                    <td colspan="6" height="20">
                                    ...
                                    <tr>
                                        <td colspan="6">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td style="width: 40%;">New filter(s) installed in the system?<asp:RadioButton ID="rdo_NewFilterInstall_Yes"
                                                    ...
                                                    <td style="width: 15%;">Number Installed:
                                                    </td>
                                                    <td style="width: 6%;">
                                                        <asp:TextBox ID="txt_NumberInstall" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 80%;"></asp:TextBox>
                                                    </td>
                                                    <td style="width: 15%;">Filter Dimensions:
                                                    </td>
                                                    <td style="width: 13%;">
                                                        <asp:TextBox ID="txt_FilterDimension" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                                    </td>
                                                    <td style="width: 13%;">
                                                        <%--  Number Cleaned:--%>
                                                    </td>
                                    ...
                                    <tr>
                                        <td colspan="6" height="40" align="center">Filter(s) to be cleaned in the system? &nbsp;<asp:RadioButton ID="rdo_FilterClean_Yes"
                                            runat="server" GroupName="FilterClean" />
                                            Yes
                                        <asp:RadioButton ID="rdo_FilterClean_No" runat="server" GroupName="FilterClean" />
                                            No&nbsp;&nbsp;&nbsp; Number Cleaned:
                                        <asp:TextBox ID="txt_NumberClean" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 15%;"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="6" height="40">Coils to be cleaned?
                                        ...
                                        <asp:RadioButton ID="rdo_CA_UnitReplace_No" runat="server" GroupName="CA_UnitReplace" />
                                            No &nbsp; &nbsp; Size of Unit:
                                        <asp:TextBox ID="txt_SizeUnit" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>&nbsp;&nbsp;&nbsp;
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">
                                        ...
                                        <asp:RadioButton ID="rdo_DuctWork_No" runat="server" GroupName="DuctWork" />
                                            No &nbsp; &nbsp; Location:<asp:TextBox ID="txt_DuctWork_Location" runat="server"
                                                Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="6" height="40">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td id="td_CentralACUnit" runat="server">Manufactured year for central AC unit present
                                                    <br />
                                                        (only if insulation is installed):
                                                    <asp:TextBox ID="txt_CentralACUnit" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 50px;"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
            ...
            <section id="Form11">
                        ...
                        <table width="100%" border="0" cellspacing="5" cellpadding="3">
                            <tr>
                                <td>Customers' heat pump is used for?&nbsp;<asp:RadioButton ID="rdoCusHeat" runat="server"
                                        ...
                                        GroupName="CusHeatPump" />A/C &nbsp;<asp:RadioButton ID="rdoCusNa" runat="server"
                                            GroupName="CusHeatPump" />N/A &nbsp;<asp:RadioButton ID="rdoCusOther" runat="server"
                                                GroupName="CusHeatPump" />Other &nbsp;<asp:TextBox ID="txtCusOther" runat="server"
                                                    Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 40%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>What are customer's Heat Pump thermostat use habits?
                                    <asp:TextBox ID="txt_customerHeatPumpThermostatUse" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 57%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>Is the thermostat accurate?
                                    ...
                                    If not,why?
                                    <asp:TextBox ID="page11_txt_ThermostatAccurate_IfNot" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 45%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>Is filter slot covered?
                            ...
                            <tr>
                                <td>If yes, is cleaning recommended?
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>If visually unable to inspect A-coil, does
                                                <br />
                            ...
                            <tr>
                                <td>If clean and tune recommended, why?
                                    <asp:TextBox ID="page11_paftxt_CleanTuneRecommended" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 62%; font-weight: normal; color: rgb(0, 0, 0); width: 70%;"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>New filter(s) installed in the system?
                                            ...
                                            <td style="width: 13%">Number Installed:
                                            </td>
                                            <td style="width: 6%">
                                                <asp:TextBox ID="page11_txt_NumberInstall" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90%;"></asp:TextBox>
                                            </td>
                                            <td style="width: 12%">Filter(s) to be cleaned in the system?
                                            </td>
                                            <td style="width: 11%">
                                            ...
                                            <td style="width: 14%">Number Cleaned:
                                            </td>
                                            <td style="width: 5%">
                                                <asp:TextBox ID="txt_NumberCleaned" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90%;"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td>
                                    <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            <td style="width: 20%;">Location:
                                                <asp:TextBox ID="txt_DuctWorkLocation" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td style="width: 30%;">Insulation to be installed?
                                            ...
                                            <td style="width: 30%;">Sealing to be completed?
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <asp:RadioButton ID="rdo_TypeHeating_Other" runat="server" GroupName="TypeHeating"
                                                    Style="margin: -5px;" />
                                                99. Other(Please describe)
                                                <asp:TextBox ID="txt_TypeHeating_Other" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 220px;"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <asp:TextBox ID="txt_ElectricHeatThermostatUse" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 62%; font-weight: normal; color: rgb(0, 0, 0); width: 57%;"
                                Width="57%"></asp:TextBox>
                                <br />
                                <br />
                            ...
                            not, why?
                            <asp:TextBox ID="txt_ThermostatAccurate" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 52%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                <br />
                                <br />
                            ...
                            <asp:RadioButton ID="page11_rdo_ReplacementThermostat_No" runat="server" GroupName="ReplacementThermostats11" />
                                No &nbsp; &nbsp; Explain Details:
                            <asp:TextBox ID="txt_ReplacementThermostats_Details" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 37%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                <br />
                                <br />
                                Is filter slot covered?
                            ...
                            <asp:RadioButton ID="rdo_FilterSlotCovere_No" runat="server" GroupName="FilterSlotCovere" />
                                No &nbsp; &nbsp; If no, install cover. &nbsp; &nbsp; Provide Locations of Thermostats:<asp:TextBox
                                    ID="txt_LocationsThermostat" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 30%; font-weight: normal; color: rgb(0, 0, 0);"
                                    runat="server"></asp:TextBox>
                                <br />
                                <br />
                                Clean/Tune?
                            ...
                            <asp:TextBox ID="txt_CleanTuneRecommended2" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 62%; font-weight: normal; color: rgb(0, 0, 0); width: 71%;"></asp:TextBox>
                                <br />
                                <br />
                            ...
                            <asp:RadioButton ID="rdo_FilterInstalled_No" runat="server" GroupName="FilterInstalled" />
                                No &nbsp; &nbsp; Number Installed:
                            <asp:TextBox ID="txt_NumberInstall2" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                <br />
                                <br />
                            ...
                            <asp:RadioButton ID="page11_rdo_FilterClean_No" runat="server" GroupName="FilterClean11" />
                                No &nbsp; &nbsp; Number Cleaned:
                            <asp:TextBox ID="page11_txt_NumberClean" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                <br />
                                <br />
                            ...
                            <asp:RadioButton ID="rdo_ElectricHeaterReplaced_No" runat="server" GroupName="ElectricHeaterReplaced" />
                                No &nbsp; &nbsp; Size of Unit:
                            <asp:TextBox ID="txt_ElectricHeaterReplaced_SizeUnit" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                <br />
                                <br />
                            ...
                            <asp:RadioButton ID="rdo_ElectricHeatRepair_No" runat="server" GroupName="ElectricHeatRepair" />
                                No &nbsp; &nbsp; Explain Details:
                            <asp:TextBox ID="txt_ElectricHeatRepair_Detail" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 45%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                <br />
                                <br />
                            ...
                            <asp:RadioButton ID="rdo_PriHeatSource_No" runat="server" GroupName="PriHeatSource1" />
                                No &nbsp; &nbsp; Location:
                            <asp:TextBox ID="txt_PriHeatSourceLocation" runat="server" Style="width: 10%; text-align: center; border: none; border-bottom: solid 1px rgb(0, 0, 0); padding-bottom: 5px; font-weight: bold; font-size: 12px; color: #666666;"></asp:TextBox><%--width="250px"--%>
                                <br />
                                <br />
                            ...
                            <asp:RadioButton ID="rdo_DuctWork2_No" runat="server" GroupName="DuctWork2" />
                                No Location:
                            <asp:TextBox ID="txt_DuctWork2Location" runat="server" Style="width: 13%; text-align: center; border: none; border-bottom: solid 1px rgb(0, 0, 0); padding-bottom: 5px; font-weight: bold; font-size: 12px; color: #666666;"
                                Width="13%"></asp:TextBox><%--width="250px"--%>
        ...
        <div style="border: 1px solid #000; width: 100%;">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                    ...
                    <td colspan="2">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                                    <strong>
                                        <asp:TextBox ID="txt_Floor1" runat="server" Style="font-weight: normal; color: rgb(0, 0, 0); border-left-style: none; border-left-color: inherit; border-left-width: medium; border-right-style: none; border-right-color: inherit; border-right-width: medium; border-top-style: none; border-top-color: inherit; border-top-width: medium;" Width="20px"></asp:TextBox>
                ...
                <tr>
                    <td colspan="2">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                                    <strong>&nbsp;<asp:TextBox ID="txt_Floor2" runat="server" Style="font-weight: normal; color: rgb(0, 0, 0); border-left-style: none; border-left-color: inherit; border-left-width: medium; border-right-style: none; border-right-color: inherit; border-right-width: medium; border-top-style: none; border-top-color: inherit; border-top-width: medium;" Width="20px"></asp:TextBox>
                                        Floor Bathrooms:</strong> Existing:
                ...
                <tr>
                    ...
                    <td width="75%">
                        <asp:TextBox ID="txt_2ndFloorBathrooms_Comment" runat="server" Width="97%" Height="120px"
                            TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                <%--   <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="5">
                    <tr>
                        ...
                        <td width="30%"><strong>Date</strong>
                            <asp:TextBox ID="txtAuditDate" runat="server" value="" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0);
                            font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                        <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtAuditDate">
                        </ajaxToolkit:CalendarExtender>
                        <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server"
                            TargetControlID="txtAuditDate" FilterType="Custom,Numbers" ValidChars="/">
                        </ajaxToolkit:FilteredTextBoxExtender>
                        </td>
                    </tr>
                </table>
      ...
      <div style="border:0px; width: 100%; height: 300px; display:block">
            <div ID="attic" runat="server" style="border: 10px solid #000; width: 47%; float: left; min-height: 300px;">
             <strong>Attic</strong>
                 <img id="attic_1" runat="server" style="width:400px; height:280px;" />
            </div>
                
            <div ID="Floor2" runat="server"  style="border: 10px solid #000; width: 47%; float: right; height:300px">
                <strong>2nd Fl</strong>
                 <img id="Floor2_1" runat="server"  style="width:400px; height:280px;" />
            </div>
      ...
      <div style="border:0px; width: 100%; height: 300px; margin-bottom: 20px; display:block">
            <div  ID="Basement" runat="server"  style="border: 10px solid #000; width: 47%; float: left; min-height: 300px;">
                <strong>Basement</strong>
                 <img id="Basement_1" runat="server"  style="width:400px; height:250px;" />
            </div>
           
            <div  ID="Floor1" runat="server" style="border: 10px solid #000; width: 47%; float: right; height:300px">
                <strong>1st Fl</strong>
                 <img id="Floor1_1" runat="server"  style="width:400px; height:250px;" />
            </div>
                        
        </div>
              <br /><br />
                                        
        <table style="margin:45px 5px" width="100%" border="0" cellspacing="0" cellpadding="20">
            ...
            <section id="Form14">
                        ...
                        <div style="page-break-after: always; border: 1px solid #000000; width: 1020px; margin: 0 auto; position: relative;">
                            ...
                            <asp:CheckBox ID="chk_BasementAirSealing_Other" runat="server" onclick="ChkBox_BasementAirSealing(this.id)" />
                                Other
                            <asp:TextBox ID="txt_BasementAirSealing_Other" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 30%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                <br />
                            ...
                            <br />
                                ...
                                <table width="100%" border="1" cellspacing="3" cellpadding="3">
                                    <tr>
                                        ...
                                        <td align="center">Sq Ft
                                        </td>
                                        <td align="center">Existing Effective R Value
                                        </td>
                                        <td align="center">Add R
                                        </td>
                                        <td align="center">New Insulation Type
                                        </td>
                                        <td align="center">Comments (such as joists running lengthwise or widthwise - 16" or 24" joist bay
                                        size)
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center" width="12%">Floor/Crawl Space
                                        </td>
                                        <td width="14%">
                                            <asp:TextBox ID="txt_FloorCrawlSpace_Location" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                        </td>
                                        <td width="7%">
                                            <asp:TextBox ID="txt_FloorCrawlSpace_SqFt" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                        </td>
                                        <td width="14%">
                                            <asp:TextBox ID="txt_FloorCrawlSpace_ExistEffect_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                        </td>
                                        <td width="7%">
                                            <asp:TextBox ID="txt_FloorCrawlSpace_Add_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                        </td>
                                        <td width="15%">
                                            <asp:TextBox ID="txt_FloorCrawlSpace_Insulation" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txt_FloorCrawlSpace_Comment" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center">Perimeter
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txt_Perimeter_ExistEffect_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                        </td>
                                        <td>
                        ...
                        <div class="newtable">
                            <table width="100%" border="1" cellspacing="2" cellpadding="2">
                                ...
                                <tr>
                                    <td align="center" width="12%">Unfloored Attic 1
                                    </td>
                                    <td width="14%">
                                        <asp:TextBox ID="txt_UnflooredAttic1_Location" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td width="7%">
                                        <asp:TextBox ID="txt_UnflooredAttic1_SqFt" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td width="15%">
                                        <asp:TextBox ID="txt_UnflooredAttic1_ExistEffect_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td width="7%">
                                        <asp:TextBox ID="txt_UnflooredAttic1_Add_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td width="14%">
                                        <asp:TextBox ID="txt_UnflooredAttic1_Insulation" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_UnflooredAttic1_Comment" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">Unfloored Attic 2
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_UnflooredAttic2_Location" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_UnflooredAttic2_SqFt" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_UnflooredAttic2_ExistEffect_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_UnflooredAttic2_Add_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_UnflooredAttic2_Insulation" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_UnflooredAttic2_Comment" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">Unfloored Attic 3
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_UnflooredAttic3_Location" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_UnflooredAttic3_SqFt" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_UnflooredAttic3_ExistEffect_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_UnflooredAttic3_Add_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_UnflooredAttic3_Insulation" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_UnflooredAttic3_Comment" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">Floored Attic 1
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txt_FlooredAttic1_ExistEffect_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_FlooredAttic1_Add_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_FlooredAttic1_Insulation" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td align="center">Floored Attic 2
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txt_FlooredAttic2_ExistEffect_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_FlooredAttic2_Add_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_FlooredAttic2_Insulation" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txt_Cathedral_ExistEffect_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td align="center">Finished Attic
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txt_FinishedAttic_ExistEffect_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_FinishedAttic_Add_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_FinishedAttic_Insulation" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td align="center">Kneewall Floored
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_KneewallFloored_Location" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_KneewallFloored_SqFt" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_KneewallFloored_ExistEffect_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_KneewallFloored_Add_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_KneewallFloored_Insulation" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_KneewallFloored_Comment" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">Kneewall Unfloored
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_KneewallUnfloored_Location" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_KneewallUnfloored_SqFt" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_KneewallUnfloored_ExistEffect_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_KneewallUnfloored_Add_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_KneewallUnfloored_Insulation" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_KneewallUnfloored_Comment" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">Slopes
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td align="center">Vertical Kneewall
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_VerticalKneewall_Location" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_VerticalKneewall_SqFt" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_VerticalKneewall_ExistEffect_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_VerticalKneewall_Add_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_VerticalKneewall_Insulation" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_VerticalKneewall_Comment" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">Vertical Kneewall
                                    ...
                                    <td>
                                        <asp:TextBox ID="txt_VerticalKneewall2_Location" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_VerticalKneewall2_SqFt" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_VerticalKneewall2_ExistEffect_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_VerticalKneewall2_Add_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_VerticalKneewall2_Insulation" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_VerticalKneewall2_Comment" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                            ...
                            <table width="100%" border="1" cellspacing="1" cellpadding="2">
                                <tr>
                                    <td align="center">Ventilation Type
                                    </td>
                                    <td align="center">Proposed Additional Ventilation
                                    </td>
                                    <td align="center">Location
                                    </td>
                                    <td align="center">Comments
                                ...
                                <tr>
                                    <td align="center" width="25%">Roof Vent
                                    </td>
                                    <td width="25%">
                                        <asp:TextBox ID="txt_RoofVent_PropeseAddVent" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td width="25%">
                                ...
                                <tr>
                                    <td align="center">Gable Vent
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_GableVent_PropeseAddVent" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td align="center">Soffit Vent
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_SoffitVent_ProposeAddVent" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td align="center">Ridge Vent
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_RidgeVent_ProposeAddVent" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                        ...
                        <div style="page-break-after: always; border: 1px solid #000000; width: 1020px; margin: 0 auto; position: relative;">
                            <div class="newtable" style="border: 1px solid #000; height: auto;">
                                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                    ...
                                    <tr>
                                        <td width="20%">Horizontal attic access - insulate to at least equivalent R value of surrounding
                                        surfaces
                                        </td>
                                        <td>
                                        ...
                                        <asp:RadioButton ID="rdo_HorizontalAttic_WillDo" runat="server" GroupName="HorizontalAttic" />
                                            Will do &nbsp; &nbsp; Location:
                                        <asp:TextBox ID="txt_HorizontalAttic_Location" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                            Weather Stripping
                                    ...
                                    <tr>
                                        <td>Vertical openings - insulate to equivalent R value of surrounding surfaces
                                        </td>
                                        <td>
                                        ...
                                        <asp:RadioButton ID="rdo_VerticalOpening_WillDo" runat="server" GroupName="VerticalOpening" />
                                            Will do &nbsp; &nbsp; Location:
                                        <asp:TextBox ID="txt_VerticalOpening_Location" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                            Weather Stripping
                                    ...
                                    <tr>
                                        <td>Pull down stairs - insulate to at least equivalent R value of surrounding surfaces
                                        </td>
                                        <td>
                                        ...
                                        <asp:RadioButton ID="rdo_PullDownStairs_WillDo" runat="server" GroupName="PullDownStairs" />
                                            Will do &nbsp; &nbsp; Location:
                                        <asp:TextBox ID="txt_PullDownStairs_Location" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                            Weather Stripping
                                    ...
                                    <tr>
                                        <td colspan="2">Are there recessed heat producing fixtures:
                                    ...
                                    <tr>
                                        <td colspan="2">How many recessed fixtures are there?
                                        <asp:TextBox ID="txt_ManyRecessedFixtures" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                            # of lights
                                        <asp:TextBox ID="txt_RecessedFixtures_Light" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                            # of fans
                                        <asp:TextBox ID="txt_RecessedFixtures_Fans" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                            # other
                                        <asp:TextBox ID="txt_RecessedFixtures_Other" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                    ...
                                    <tr>
                                        <td colspan="2">How many are IC rated?
                                        <asp:TextBox ID="txt_IC_Rated" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                            How many are non-IC rated?
                                        <asp:TextBox ID="txt_Non_IC_Rated" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                            How many have an unknown rating?
                                        <asp:TextBox ID="txt_Unknown_IC_Rated" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">How many will be dammed to protect them from insulation?<asp:TextBox ID="txt_Protect_Insulation"
                                            runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 80px;"></asp:TextBox>
                                            How many will be air sealed either with sealed dams or with air tight inserts?<asp:TextBox
                                                ID="txt_AirSealed" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 80px;"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">Will customer allow recessed light(s) to be changed out?
                                    ...
                                    <tr>
                                        <td colspan="2">How many will be replaced with either air tight, IC rated recessed fixtures, or
                                        surface mounted fixtures?
                                        <asp:TextBox ID="txt_Replace_AirTightICRatedRecessedFixtures" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">How many are under the floored attic and protected with metal dam blocking or fiberglass
                                        batt blocking?
                                        <asp:TextBox ID="txt_HorizontalAttic_DamBlock" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                    ...
                                    <tr>
                                        <td colspan="2">Be sure to dam any chimney flues. Recommended?
                                        ...
                                        <asp:RadioButton ID="rdo_DamChimneyFlues_No" runat="server" GroupName="DamChimneyFlues" />
                                            No &nbsp; &nbsp; # of chimneys:
                                        <asp:TextBox ID="txt_DamChimneyFlues" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 80px;"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            <div class="newtable" style="border: 1px solid #000; height: auto; margin-top: 3px;">
                                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                    ...
                                    <tr>
                                        <td>Are there cantilever overhangs?
                                    ...
                                    <tr>
                                        <td>Are floor joists bays blocked?
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="1" cellspacing="0" cellpadding="3">
                                                <tr>
                                                    <td align="center" width="15%">Area
                                                    </td>
                                                    <td align="center" width="15%">Location
                                                    </td>
                                                    <td align="center">Sq Ft
                                                    </td>
                                                    <td align="center" width="15%">Existing Effective R Value
                                                    </td>
                                                    <td align="center">Add R
                                                    </td>
                                                    <td align="center" width="15%">New Insulation Type
                                                    </td>
                                                    <td align="center" width="30%">Comments
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center">Cantilever
                                                    </td>
                                                    <td align="center">
                                                    ...
                                                    <td align="center">
                                                        <asp:TextBox ID="txt_Cantilever1_ExistEffect_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                                    </td>
                                                    <td align="center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <asp:TextBox ID="txt_Cantilever2_ExistEffect_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                                    </td>
                                                    <td align="center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <asp:TextBox ID="txt_BayWindow_ExistEffect_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                                    </td>
                                                    <td align="center">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="1">
                                    ...
                                    <tr>
                                        ...
                                        <asp:CheckBox ID="chk_Siding_Brick" runat="server" />
                                            Brick &nbsp; &nbsp; Other
                                        <asp:TextBox ID="txt_Siding_Other" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 30%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Interior Wall Material:
                                        <asp:TextBox ID="txt_InteriorWallMaterial" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 79%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Can side walls be insulated?
                                        ...
                                        <asp:RadioButton ID="rdo_SideWallInsulated_No" runat="server" GroupName="SideWallInsulated" />
                                            No &nbsp; &nbsp; If not, why?
                                        <asp:TextBox ID="txt_SideWallInsulated_IfNot" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); width: 45%; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>If yes, list the facing direction of the side walls you want to insulate &nbsp;
                                        North
                                        <asp:TextBox ID="txt_FaceDirection_Wall_North" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 40px;"></asp:TextBox>
                                            sq ft &nbsp; South
                                        <asp:TextBox ID="txt_FaceDirection_Wall_South" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 40px;"></asp:TextBox>
                                            sq ft &nbsp; East
                                        <asp:TextBox ID="txt_FaceDirection_Wall_East" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 40px;"></asp:TextBox>
                                            sq ft &nbsp; West
                                        <asp:TextBox ID="txt_FaceDirection_Wall_West" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 40px;"></asp:TextBox>
                                            &nbsp; sq ft
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td width="27%" valign="top">Document side wall issues such as weak
                                                    <br />
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="1" cellspacing="0" cellpadding="5">
                                                <tr>
                                                    <td width="15%" align="center">Area
                                                    </td>
                                                    <td align="center">Sq Ft
                                                    </td>
                                                    <td width="15%" align="center">Existing Effective R Value
                                                    </td>
                                                    <td align="center">Add R
                                                    </td>
                                                    <td width="15%" align="center">New Insulation Type
                                                    </td>
                                                    <td width="40%" align="center">Comments
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center">Garage Ceiling
                                                    </td>
                                                    <td align="center">
                                                        <asp:TextBox ID="txt_GarageCeiling_SqFt" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                                    </td>
                                                    <td align="center">
                                                        <asp:TextBox ID="txt_GarageCeiling_ExistEffect_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                                    </td>
                                                    <td align="center">
                                                        <asp:TextBox ID="txt_GarageCeiling_Add_R" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                                    </td>
                                                    <td align="center">
                                                        <asp:TextBox ID="txt_GarageCeiling_Insulation" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                                    </td>
                                                    <td align="center">
                                    ...
                                    <tr>
                                        <td>Is garage isolated from thermal envelope?
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td width="20%">Other Zones outside Thermal and Pressure Boundaries, ie porches, bay windows
                                                    </td>
                                                    <td>
            ...
            <section id="Form16">
                        <%--Page 16 start--%>
                        <div style="page-break-after:always; border:1px solid #000000; width:1050px; margin:0 auto; position:relative;"> 
       
        <!--main_right begin-->
        <p style="text-align: center; padding-bottom: 0; font-size: 16px; margin:2px 0px;">
        ...
        <div class="newtable" style="border: 1px solid #000; height: auto;">
            ...
            <div>
                ...
                Enter P or B(larger # of the 2):<asp:TextBox ID="txt_EnterPorB" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 25px;"></asp:TextBox>
                4. Multiply by height corrected N Factor:<asp:TextBox ID="txt_CorrectedFactor" runat="server"
                    Width="88px" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 25px;"></asp:TextBox>
                <br />
               
            </div>
            <div>
                <div class="margindiv">
                    <table width="270" border="1" style="border: solid 1px #999; text-align: center; float: left;">
                        <tr>
                    ...
                    <br />
                    <div class="tableone" style="float: left; width: 160px;">
                        <p style="float: left; margin:5px 0; text-align:right">
                            N Factor (online</br> completion)
                        </p>
                        <asp:TextBox ID="txt_FactorOnline" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0); font-weight: normal; color: rgb(0, 0, 0); width: 35px; margin-top: 20px;"></asp:TextBox>
                    </div>
                    <div class="tableone" style="width: 240px; float: left;">
                    ...
                    <div class="tableone" align="right" style="float: left; width: 240px; margin-top: 0;">
                    ...
                    <p style=" width: 62%; float: right; margin:0px 2px;">
                ...
                <p style="padding: 2px 6px; float: left; font-style: italic; margin:2px 0px">
                ...
                <div class="newtable">
                    ...
                    <p style="padding: 2px 0; margin:2px 0px;">
                        ...
                        Metal<br /><asp:CheckBox ID="Chk_Matrial_Ductbord" runat="server" />
                        Ductboard<asp:CheckBox ID="Chk_Matrial_Flex" runat="server" />
                        Flex
                    </p>
                    <p align="center" style="margin:2px 0px;">
                        System Type:
                      ...
                      <tr>
                            ...
                            <table>
                                <tr>
                                    <td style="border-right: 1px solid black;">&nbsp;
                                        <asp:TextBox ID="txt_Supply_pre1" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_Supply_pro1" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            <table>
                                <tr>
                                    <td style="border-right: 1px solid black;">&nbsp;
                                        <asp:TextBox ID="txt_Supply_pre2" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_Supply_pro2" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            <table>
                                <tr>
                                    <td style="border-right: 1px solid black;">&nbsp;
                                        <asp:TextBox ID="txt_Supply_pre3" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_Supply_pro3" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            <table>
                                <tr>
                                    <td style="border-right: 1px solid black;">&nbsp;
                                        <asp:TextBox ID="txt_Supply_pre4" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_Supply_pro4" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            <table>
                                <tr>
                                    <td style="border-right: 1px solid black;">&nbsp;
                                        <asp:TextBox ID="txt_Supply_pre5" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_Supply_pro5" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            <table>
                                <tr>
                                    <td style="border-right: 1px solid black;">&nbsp;
                                        <asp:TextBox ID="txt_Supply_pre6" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_Supply_pro6" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            <table>
                                <tr>
                                    <td style="border-right: 1px solid black;">&nbsp;
                                        <asp:TextBox ID="txt_Supply_pre7" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_Supply_pro7" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            <table>
                                <tr>
                                    <td style="border-right: 1px solid black;">&nbsp;
                                        <asp:TextBox ID="txt_Supply_pre8" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_Supply_pro8" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                <tr>
                                    <td style="border-right: 1px solid black;">&nbsp;
                                        <asp:TextBox ID="txt_Return_pre1" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_Return_pro1" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            <table>
                                <tr>
                                    <td style="border-right: 1px solid black;">&nbsp;
                                        <asp:TextBox ID="txt_Return_pre2" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_Return_pro2" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            <table>
                                <tr>
                                    <td style="border-right: 1px solid black;">&nbsp;
                                        <asp:TextBox ID="txt_Return_pre3" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_Return_pro3" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            <table>
                                <tr>
                                    <td style="border-right: 1px solid black;">&nbsp;
                                        <asp:TextBox ID="txt_Return_pre4" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_Return_pro4" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            <table>
                                <tr>
                                    <td style="border-right: 1px solid black;">&nbsp;
                                        <asp:TextBox ID="txt_Return_pre5" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_Return_pro5" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            <table>
                                <tr>
                                    <td style="border-right: 1px solid black;">&nbsp;
                                        <asp:TextBox ID="txt_Return_pre6" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_Return_pro6" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            <table>
                                <tr>
                                    <td style="border-right: 1px solid black;">&nbsp;
                                        <asp:TextBox ID="txt_Return_pre7" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_Return_pro7" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            <table>
                                <tr>
                                    <td style="border-right: 1px solid black;">&nbsp;
                                        <asp:TextBox ID="txt_Return_pre8" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_Return_pro8" runat="server" Style="border: 0; width: 100%; font-size: 12px;"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <p style="padding: 3px 7px; margin:5px 0px;">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="txt_TestDate" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0);
                            width: 250px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                        <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txt_TestDate"
            ...
            <div class="newtable" style="border: 1px solid #000; padding: 2px; height: auto;">
                ...
                <table width="100%" border="1" cellspacing="0" cellpadding="1">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <asp:TextBox ID="txt_Optional_Other_Stack" runat="server" Style="width: 20px; border: none;"
                                Height="18px" Width="20px"></asp:TextBox>
                        </td>
                        <td align="center">
                 ...
                 <table width="100%" cellspacing="0" cellpadding="1" style="color:red; border: solid 1px Red;">
                     ...
                     <tr>
                         <td>
                             Total BTUH <asp:TextBox ID="txt_Total_BTUH" runat="server" Style="border-bottom: solid 1px rgb(0, 0, 0); border-left-style: none; border-left-color: inherit; border-left-width: medium; border-right-style: none; border-right-color: inherit; border-right-width: medium; border-top-style: none; border-top-color: inherit; border-top-width: medium;" Width="60px"></asp:TextBox> Input/1000*50= <asp:TextBox ID="txt_VolumeCombustionAir" runat="server" Style="border-bottom: solid 1px rgb(0, 0, 0); border-left-style: none; border-left-color: inherit; border-left-width: medium; border-right-style: none; border-right-color: inherit; border-right-width: medium; border-top-style: none; border-top-color: inherit; border-top-width: medium;" Width="65px"></asp:TextBox>the cu.ft.volume of combustion air required.
                         </td>
                     </tr>  
               </table>
                <table width="100%" border="0" cellspacing="0" cellpadding="5">
                    <tr>
                        ...
                        <td>
                            <table border="0" width="100%">
                                <tr>
                                    <td width="33%" align="top" style="vertical-align: 0; width: 262px; margin: 0px 0px 0px 70px;border:0px;
                                        float: left;">
                                        <div class="newtable" style="border: 1px solid #000; padding: 5px; height: auto;
                                            width: 70%;">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="10" style="border:0px;">
                                                <tr>
                                                    <td style="border:0px;">
                                    ...
                                    <td align="right" valign="top" style="float: left; width: 160px; text-align: center; border:0px;">
                                        <table border="1" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td colspan="9" align="center" style="border:0px;">
                                                    <%-- <div style="background: #eaeaea; padding: 4px; height: 120px;">--%>
                                ...
                                <tr>
                                    <td align="right" valign="top" width="100%" style="border:0px;">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                <tr>
                    <td>
                        ...
                        <br />
                        Pass?
                        <asp:RadioButton ID="rdo_CAZPass1_Yes" runat="server" GroupName="testgroup17" />Yes
                        <asp:RadioButton ID="rdo_CAZPass1_No" runat="server" GroupName="testgroup17" />No
                        <br />
                        <br />
        ...
        <div class="newtable">
            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                ...
                <tr>
                    <td width="27%" style="text-align: left">
                        <%--<asp:RadioButton ID="page18_rdo_PreTest" runat="server" GroupName="tes_ting" />--%>
                        <asp:CheckBox ID="page18_rdo_PreTest" runat="server" onclick="PrePost(this.id);" />
                        Pre-test
                    </td>
                    <td width="27%">
                        <%--<asp:RadioButton ID="page18_rdo_PostTest" runat="server" GroupName="tes_ting" />--%>
                        <asp:CheckBox ID="page18_rdo_PostTest" runat="server" onclick="PrePost(this.id);" />
                        Post-Test
                    </td>
                    <td width="90%">
                        Tech Name
                ...
                <tr>
                    <td>
                        <%--<asp:RadioButton ID="page18_rdo_Auditor" runat="server" GroupName="testing" />--%>
                        <asp:CheckBox ID="page18_rdo_Auditor" runat="server" onclick="AuditorCrew(this.id);" />
                        Auditor
                    </td>
                    <td>
                        <%--<asp:RadioButton ID="page18_rdo_Crew" runat="server" GroupName="testing" />--%>
                        <asp:CheckBox ID="page18_rdo_Crew" runat="server" onclick="AuditorCrew(this.id);" />
                        Crew
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="page18_txt_TestDate" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0);
                            width: 250px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                        <ajaxToolkit:CalendarExtender ID="page18_CalendarExtender2" runat="server" TargetControlID="page18_txt_TestDate"
                            OnClientDateSelectionChanged="checkDate">
                        </ajaxToolkit:CalendarExtender>
                        <ajaxToolkit:FilteredTextBoxExtender ID="page18_FilteredTextBoxExtender3" runat="server"
                            TargetControlID="page18_txt_TestDate" FilterType="Custom,Numbers" ValidChars="/">
                        </ajaxToolkit:FilteredTextBoxExtender>
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
                        <strong>Combustion Safety Testing</strong> Are there Combustion Appliances?
                        <asp:RadioButton ID="page18_rdo_CombustionAppliances_Yes" runat="server" GroupName="test1" />
                        Yes
                        <asp:RadioButton ID="page18_rdo_CombustionAppliances_No" runat="server" GroupName="test1" />
                        No
                    </td>
                </tr>
                <tr>
            ...
            <div class="newtable" style="border: 1px solid #000; padding: 2px; height: auto;">
                ...
                <table width="100%" border="1" cellspacing="0" cellpadding="1">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Co_WaterHeater_AMB" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Co_WaterHeater_CAZ" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_After_WaterHeater_AMB" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_After_WaterHeater_CAZ" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_GasLeak_WaterHeater" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Flame_WaterHeater" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoFuel_WaterHeater_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoFuel_WaterHeater_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoPass_WaterHeater_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoPass_WaterHeater_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Co_FurnaceBoil_AMB" runat="server" Style="width: 20px; border: none;"
                                Height="18px"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Co_FurnaceBoil_CAZ" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page18_txt_GasLeak_FurnaceBoil" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Flame_FurnaceBoil" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoFuel_FurnaceBoil_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoFuel_FurnaceBoil_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoPass_FurnaceBoil_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoPass_FurnaceBoil_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoAfter_GasRange_AMB" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoAfter_GasRange_CAZ" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_GasLeak_GasRange" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Flame_GasRange" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Spillage_GasRange_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Spillage_GasRange_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page18_txt_DraftPress_GasRange_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page18_txt_DraftPass_GasRange_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_DraftPass_GasRange_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoFuel_GasRange_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoFuel_GasRange_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoPass_GasRange_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoPass_GasRange_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Optional_GasRange_O2" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Optional_GasRange_Eff" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoAfter_Other_AMB" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoAfter_Other_CAZ" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Spillage_Other_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Spillage_Other_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_SpillageAfter_Other_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page18_txt_DraftPress_Other_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_DraftPress_Other_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_DraftPass_Other_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_DraftPass_Other_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoFuel_Other_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoFuel_Other_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoPass_Other_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoPass_Other_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Optional_Other_Stack" runat="server" Style="width: 20px; border: none;"
                                Height="18px" Width="20px"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Optional_Other_O2" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Optional_Other_Eff" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Col1Cat" runat="server" Style="width: 70px; border: none; font-size: 11px;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoAfter_Col1Cat_AMB" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoAfter_Col1Cat_CAZ" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Spillage_Col1Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Spillage_Col1Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page18_txt_DraftPress_Col1Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_DraftPress_Col1Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_DraftPass_Col1Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_DraftPass_Col1Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoFuel_Col1Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoFuel_Col1Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoPass_Col1Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoPass_Col1Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Optional_Col1Cat_Stack" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Optional_Col1Cat_O2" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Optional_Col1Cat_Eff" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Col2Cat" runat="server" Style="width: 70px; border: none; font-size: 11px;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoAfter_Col2Cat_AMB" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoAfter_Col2Cat_CAZ" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Spillage_Col2Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Spillage_Col2Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page18_txt_DraftPress_Col2Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_DraftPress_Col2Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_DraftPass_Col2Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_DraftPass_Col2Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoFuel_Col2Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoFuel_Col2Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoPass_Col2Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_CoPass_Col2Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Optional_Col2Cat_Stack" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Optional_Col2Cat_O2" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page18_txt_Optional_Col2Cat_Eff" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                    </tr>
                 ...
                 <table width="100%" cellspacing="0" cellpadding="1" style="color:red; border: solid 1px Red;">
                     ...
                     <tr>
                         <td>
                             Total BTUH <asp:TextBox ID="page18_txt_Total_BTUH" runat="server" Style="border-bottom: solid 1px rgb(0, 0, 0); border-left-style: none; border-left-color: inherit; border-left-width: medium; border-right-style: none; border-right-color: inherit; border-right-width: medium; border-top-style: none; border-top-color: inherit; border-top-width: medium;" Width="60px"></asp:TextBox> Input/1000*50= <asp:TextBox ID="page18_txt_VolumeCombustionAir" runat="server" Style="border-bottom: solid 1px rgb(0, 0, 0); border-left-style: none; border-left-color: inherit; border-left-width: medium; border-right-style: none; border-right-color: inherit; border-right-width: medium; border-top-style: none; border-top-color: inherit; border-top-width: medium;" Width="65px"></asp:TextBox>the cu.ft.volume of combustion air required.
                         </td>
                     </tr>  
               </table>
                <table width="100%" border="0" cellspacing="0" cellpadding="5">
                    <tr>
                        ...
                        <td>
                            <table border="0" width="100%">
                                <tr>
                                    <td width="33%" align="top" style="border: 0px; vertical-align: 0; width: 262px; margin: 0px 0px 0px 70px;
                                        float: left;">
                                        <div class="newtable" style="border: 1px solid #000; padding: 5px; height: auto;
                                            width: 70%;">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="10">
                                        ...
                                        <table border="1" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td colspan="9" align="center">
                                                    <%-- <div style="background: #eaeaea; padding: 4px; height: 120px;">--%>
                                                    <asp:TextBox ID="page18_txt_Note1_17" runat="server" TextMode="MultiLine" Style="background: #eaeaea;
                                                        padding: 4px; height: 120px;"></asp:TextBox>
                                                    <%--</div>--%>
                                                </td>
                                            </tr>
                                ...
                                <tr>
                                    <td align="right" valign="top" width="100%" style="border: 0px;">
                                        ...
                                        <asp:TextBox ID="page18_txt_CoNotes" runat="server" Style="border: solid 1px #000; padding: 5px;
                                            width: 88%; height: 46px;" TextMode="MultiLine"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                <tr>
                    <td>
                        Outdoor Temperature:
                        <asp:TextBox ID="page18_txt_OutdoorTemperature" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0);
                            font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                        <br />
                        <br />
                        CAZ Worse Case Depressurization: Natural:
                        ...
                        <br />
                        Pass?
                        <asp:RadioButton ID="page18_rdo_CAZPass1_Yes" runat="server" GroupName="testgroup18" />Yes
                        <asp:RadioButton ID="page18_rdo_CAZPass1_No" runat="server" GroupName="testgroup18" />No
                        <br />
                        <br />
        ...
        <div class="newtable">
            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                ...
                <tr>
                    <td width="27%" style="text-align: left">
                        <%--<asp:RadioButton ID="page19_rdo_PreTest" runat="server" GroupName="tes_ting" />--%>
                        <asp:CheckBox ID="page19_rdo_PreTest" runat="server" onclick="PrePost(this.id);" />
                        Pre-test
                    </td>
                    <td width="27%">
                        <%--<asp:RadioButton ID="page19_rdo_PostTest" runat="server" GroupName="tes_ting" />--%>
                        <asp:CheckBox ID="page19_rdo_PostTest" runat="server" onclick="PrePost(this.id);" />
                        Post-Test
                    </td>
                    <td width="90%">
                        Tech Name
                ...
                <tr>
                    <td>
                        <%--<asp:RadioButton ID="page19_rdo_Auditor" runat="server" GroupName="testing" />--%>
                        <asp:CheckBox ID="page19_rdo_Auditor" runat="server" onclick="AuditorCrew(this.id);" />
                        Auditor
                    </td>
                    <td>
                        <%--<asp:RadioButton ID="page19_rdo_Crew" runat="server" GroupName="testing" />--%>
                        <asp:CheckBox ID="page19_rdo_Crew" runat="server" onclick="AuditorCrew(this.id);" />
                        Crew
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="page19_txt_TestDate" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0);
                            width: 250px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                        <ajaxToolkit:CalendarExtender ID="page19_CalendarExtender2" runat="server" TargetControlID="txt_TestDate"
                            OnClientDateSelectionChanged="checkDate">
                        </ajaxToolkit:CalendarExtender>
                        <ajaxToolkit:FilteredTextBoxExtender ID="page19_FilteredTextBoxExtender3" runat="server"
                            TargetControlID="txt_TestDate" FilterType="Custom,Numbers" ValidChars="/">
                        </ajaxToolkit:FilteredTextBoxExtender>
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
                        <strong>Combustion Safety Testing</strong> Are there Combustion Appliances?
                        <asp:RadioButton ID="page19_rdo_CombustionAppliances_Yes" runat="server" GroupName="test2" />
                        Yes
                        <asp:RadioButton ID="page19_rdo_CombustionAppliances_No" runat="server" GroupName="test2" />
                        No
                    </td>
                </tr>
                <tr>
            ...
            <div class="newtable" style="border: 1px solid #000; padding: 2px; height: auto;">
                Are there any <u>unvented</u> combustion heating appliances?
                <asp:RadioButton ID="page19_rdo_UnventedCombustionHeatingApp_Y" runat="server" GroupName="tester19" />
                Yes
                <asp:RadioButton ID="page19_rdo_UnventedCombustionHeatingApp_N" runat="server" GroupName="tester19" />
                No
                <table width="100%" border="1" cellspacing="0" cellpadding="1">
                    <tr>
                        <td align="center">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Co_WaterHeater_AMB" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Co_WaterHeater_CAZ" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_After_WaterHeater_AMB" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_After_WaterHeater_CAZ" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_GasLeak_WaterHeater" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Flame_WaterHeater" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoFuel_WaterHeater_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoFuel_WaterHeater_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoPass_WaterHeater_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoPass_WaterHeater_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Co_FurnaceBoil_AMB" runat="server" Style="width: 20px; border: none;"
                                Height="18px"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Co_FurnaceBoil_CAZ" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page19_txt_GasLeak_FurnaceBoil" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Flame_FurnaceBoil" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoFuel_FurnaceBoil_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoFuel_FurnaceBoil_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoPass_FurnaceBoil_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoPass_FurnaceBoil_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoAfter_GasRange_AMB" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoAfter_GasRange_CAZ" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_GasLeak_GasRange" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Flame_GasRange" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Spillage_GasRange_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Spillage_GasRange_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page19_txt_DraftPress_GasRange_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page19_txt_DraftPass_GasRange_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_DraftPass_GasRange_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoFuel_GasRange_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoFuel_GasRange_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoPass_GasRange_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoPass_GasRange_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Optional_GasRange_O2" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Optional_GasRange_Eff" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoAfter_Other_AMB" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoAfter_Other_CAZ" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Spillage_Other_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Spillage_Other_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_SpillageAfter_Other_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page19_txt_DraftPress_Other_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_DraftPress_Other_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_DraftPass_Other_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_DraftPass_Other_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoFuel_Other_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoFuel_Other_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoPass_Other_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoPass_Other_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Optional_Other_Stack" runat="server" Style="width: 20px; border: none;"
                                Height="18px" Width="20px"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Optional_Other_O2" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Optional_Other_Eff" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Col1Cat" runat="server" Style="width: 70px; border: none; font-size: 11px;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoAfter_Col1Cat_AMB" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoAfter_Col1Cat_CAZ" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Spillage_Col1Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Spillage_Col1Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page19_txt_DraftPress_Col1Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_DraftPress_Col1Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_DraftPass_Col1Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_DraftPass_Col1Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoFuel_Col1Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoFuel_Col1Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoPass_Col1Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoPass_Col1Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Optional_Col1Cat_Stack" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Optional_Col1Cat_O2" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Optional_Col1Cat_Eff" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Col2Cat" runat="server" Style="width: 70px; border: none; font-size: 11px;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoAfter_Col2Cat_AMB" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoAfter_Col2Cat_CAZ" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Spillage_Col2Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Spillage_Col2Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page19_txt_DraftPress_Col2Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_DraftPress_Col2Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_DraftPass_Col2Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_DraftPass_Col2Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoFuel_Col2Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoFuel_Col2Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoPass_Col2Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_CoPass_Col2Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Optional_Col2Cat_Stack" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Optional_Col2Cat_O2" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page19_txt_Optional_Col2Cat_Eff" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                    </tr>
                 ...
                 <table width="100%" cellspacing="0" cellpadding="1" style="color:red; border: solid 1px Red;">
                     ...
                     <tr>
                         <td>
                             Total BTUH <asp:TextBox ID="page19_txt_Total_BTUH" runat="server" Style="border-bottom: solid 1px rgb(0, 0, 0); border-left-style: none; border-left-color: inherit; border-left-width: medium; border-right-style: none; border-right-color: inherit; border-right-width: medium; border-top-style: none; border-top-color: inherit; border-top-width: medium;" Width="60px"></asp:TextBox> Input/1000*50= <asp:TextBox ID="page19_txt_VolumeCombustionAir" runat="server" Style="border-bottom: solid 1px rgb(0, 0, 0); border-left-style: none; border-left-color: inherit; border-left-width: medium; border-right-style: none; border-right-color: inherit; border-right-width: medium; border-top-style: none; border-top-color: inherit; border-top-width: medium;" Width="65px"></asp:TextBox>the cu.ft.volume of combustion air required.
                         </td>
                     </tr>  
               </table>
                <table width="100%" border="0" cellspacing="0" cellpadding="5">
                            ...
                            <table border="0" width="100%">
                                    ...
                                    <td align="right" valign="top" style="float: left; width: 160px; text-align: center; border: 0px;">
                                        <table border="1" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td colspan="9" align="center">
                                                    <%-- <div style="background: #eaeaea; padding: 4px; height: 120px;">--%>
                                                    <asp:TextBox ID="page19_txt_Note1_17" runat="server" TextMode="MultiLine" Style="background: #eaeaea;
                                                        padding: 4px; height: 120px;"></asp:TextBox>
                                                    <%--</div>--%>
                                                </td>
                                            </tr>
                                ...
                                <tr>
                                    <td align="right" valign="top" width="100%" style="border: 0px;">
                                        ...
                                        <asp:TextBox ID="page19_txt_CoNotes" runat="server" Style="border: solid 1px #000; padding: 5px;
                                            width: 88%; height: 46px;" TextMode="MultiLine"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                <tr>
                    <td>
                        Outdoor Temperature:
                        <asp:TextBox ID="page19_txt_OutdoorTemperature" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0);
                            font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                        <br />
                        <br />
                        CAZ Worse Case Depressurization: Natural:
                        ...
                        <br />
                        Pass?
                        <asp:RadioButton ID="page19_rdo_CAZPass1_Yes" runat="server" GroupName="testgroup19" />Yes
                        <asp:RadioButton ID="page19_rdo_CAZPass1_No" runat="server" GroupName="testgroup19" />No
                        <br />
                        <br />
        ...
        <div class="newtable">
            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                ...
                <tr>
                    <td width="27%" style="text-align: left">
                        <%--<asp:RadioButton ID="page20_rdo_PreTest" runat="server" GroupName="tes_ting" />--%>
                        <asp:CheckBox ID="page20_rdo_PreTest" runat="server" onclick="PrePost(this.id);" />
                        Pre-test
                    </td>
                    <td width="27%">
                        <%--<asp:RadioButton ID="page20_rdo_PostTest" runat="server" GroupName="tes_ting" />--%>
                        <asp:CheckBox ID="page20_rdo_PostTest" runat="server" onclick="PrePost(this.id);" />
                        Post-Test
                    </td>
                    <td width="90%">
                        Tech Name
                ...
                <tr>
                    <td>
                        <%--<asp:RadioButton ID="page20_rdo_Auditor" runat="server" GroupName="testing" />--%>
                        <asp:CheckBox ID="page20_rdo_Auditor" runat="server" onclick="AuditorCrew(this.id);" />
                        Auditor
                    </td>
                    <td>
                        <%--<asp:RadioButton ID="page20_rdo_Crew" runat="server" GroupName="testing" />--%>
                        <asp:CheckBox ID="page20_rdo_Crew" runat="server" onclick="AuditorCrew(this.id);" />
                        Crew
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="page20_txt_TestDate" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0);
                            width: 250px; font-weight: normal; color: rgb(0, 0, 0);"></asp:TextBox>
                        <ajaxToolkit:CalendarExtender ID="page20_CalendarExtender2" runat="server" TargetControlID="txt_TestDate"
                            OnClientDateSelectionChanged="checkDate">
                        </ajaxToolkit:CalendarExtender>
                        <ajaxToolkit:FilteredTextBoxExtender ID="page20_FilteredTextBoxExtender3" runat="server"
                            TargetControlID="txt_TestDate" FilterType="Custom,Numbers" ValidChars="/">
                        </ajaxToolkit:FilteredTextBoxExtender>
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
                        <strong>Combustion Safety Testing</strong> Are there Combustion Appliances?
                        <asp:RadioButton ID="page20_rdo_CombustionAppliances_Yes" runat="server" GroupName="test3" />
                        Yes
                        <asp:RadioButton ID="page20_rdo_CombustionAppliances_No" runat="server" GroupName="test3" />
                        No
                    </td>
                </tr>
                <tr>
            ...
            <div class="newtable" style="border: 1px solid #000; padding: 2px; height: auto;">
                Are there any <u>unvented</u> combustion heating appliances?
                <asp:RadioButton ID="page20_rdo_UnventedCombustionHeatingApp_Y" runat="server" GroupName="tester20" />
                Yes
                <asp:RadioButton ID="page20_rdo_UnventedCombustionHeatingApp_N" runat="server" GroupName="tester20" />
                No
                <table width="100%" border="1" cellspacing="0" cellpadding="1">
                    <tr>
                        <td align="center">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Co_WaterHeater_AMB" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Co_WaterHeater_CAZ" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_After_WaterHeater_AMB" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_After_WaterHeater_CAZ" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_GasLeak_WaterHeater" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Flame_WaterHeater" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoFuel_WaterHeater_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoFuel_WaterHeater_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoPass_WaterHeater_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoPass_WaterHeater_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Co_FurnaceBoil_AMB" runat="server" Style="width: 20px; border: none;"
                                Height="18px"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Co_FurnaceBoil_CAZ" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page20_txt_GasLeak_FurnaceBoil" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Flame_FurnaceBoil" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoFuel_FurnaceBoil_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoFuel_FurnaceBoil_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoPass_FurnaceBoil_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoPass_FurnaceBoil_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoAfter_GasRange_AMB" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoAfter_GasRange_CAZ" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_GasLeak_GasRange" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Flame_GasRange" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Spillage_GasRange_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Spillage_GasRange_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page20_txt_DraftPress_GasRange_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page20_txt_DraftPass_GasRange_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_DraftPass_GasRange_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoFuel_GasRange_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoFuel_GasRange_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoPass_GasRange_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoPass_GasRange_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Optional_GasRange_O2" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Optional_GasRange_Eff" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoAfter_Other_AMB" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoAfter_Other_CAZ" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Spillage_Other_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Spillage_Other_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_SpillageAfter_Other_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page20_txt_DraftPress_Other_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_DraftPress_Other_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_DraftPass_Other_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_DraftPass_Other_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoFuel_Other_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoFuel_Other_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoPass_Other_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoPass_Other_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Optional_Other_Stack" runat="server" Style="width: 20px; border: none;"
                                Height="18px" Width="20px"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Optional_Other_O2" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Optional_Other_Eff" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Col1Cat" runat="server" Style="width: 70px; border: none; font-size: 11px;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoAfter_Col1Cat_AMB" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoAfter_Col1Cat_CAZ" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Spillage_Col1Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Spillage_Col1Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page20_txt_DraftPress_Col1Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_DraftPress_Col1Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_DraftPass_Col1Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_DraftPass_Col1Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoFuel_Col1Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoFuel_Col1Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoPass_Col1Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoPass_Col1Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Optional_Col1Cat_Stack" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Optional_Col1Cat_O2" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Optional_Col1Cat_Eff" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Col2Cat" runat="server" Style="width: 70px; border: none; font-size: 11px;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoAfter_Col2Cat_AMB" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoAfter_Col2Cat_CAZ" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Spillage_Col2Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Spillage_Col2Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:TextBox ID="page20_txt_DraftPress_Col2Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_DraftPress_Col2Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_DraftPass_Col2Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_DraftPass_Col2Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoFuel_Col2Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoFuel_Col2Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoPass_Col2Cat_WC" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_CoPass_Col2Cat_NAT" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Optional_Col2Cat_Stack" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Optional_Col2Cat_O2" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                        <td align="center">
                            <asp:TextBox ID="page20_txt_Optional_Col2Cat_Eff" runat="server" Style="width: 20px; border: none;"></asp:TextBox>
                        </td>
                    </tr>
                 ...
                 <table width="100%" cellspacing="0" cellpadding="1" style="color:red; border: solid 1px Red;">
                     ...
                     <tr>
                         <td>
                             Total BTUH <asp:TextBox ID="page20_txt_Total_BTUH" runat="server" Style="border-bottom: solid 1px rgb(0, 0, 0); border-left-style: none; border-left-color: inherit; border-left-width: medium; border-right-style: none; border-right-color: inherit; border-right-width: medium; border-top-style: none; border-top-color: inherit; border-top-width: medium;" Width="60px"></asp:TextBox> Input/1000*50= <asp:TextBox ID="page20_txt_VolumeCombustionAir" runat="server" Style="border-bottom: solid 1px rgb(0, 0, 0); border-left-style: none; border-left-color: inherit; border-left-width: medium; border-right-style: none; border-right-color: inherit; border-right-width: medium; border-top-style: none; border-top-color: inherit; border-top-width: medium;" Width="65px"></asp:TextBox>the cu.ft.volume of combustion air required.
                         </td>
                     </tr>  
               </table>
                <table width="100%" border="0" cellspacing="0" cellpadding="5">
                            ...
                            <table border="0" width="100%">
                                    ...
                                    <td align="right" valign="top" style="float: left; width: 160px; text-align: center; border: 0px;">
                                        <table border="1" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td colspan="9" align="center" style="border: 0px;">
                                                    <%-- <div style="background: #eaeaea; padding: 4px; height: 120px;">--%>
                                                    <asp:TextBox ID="page20_txt_Note1_17" runat="server" TextMode="MultiLine" Style="background: #eaeaea;
                                                        padding: 4px; height: 120px;"></asp:TextBox>
                                                    <%--</div>--%>
                                                </td>
                                            </tr>
                                ...
                                <tr>
                                    <td align="right" valign="top" width="100%" style="border: 0px;">
                                        ...
                                        <asp:TextBox ID="page20_txt_CoNotes" runat="server" Style="border: solid 1px #000; padding: 5px;
                                            width: 88%; height: 46px;" TextMode="MultiLine"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                <tr>
                    <td>
                        Outdoor Temperature:
                        <asp:TextBox ID="page20_txt_OutdoorTemperature" runat="server" Style="border: none; border-bottom: solid 1px rgb(0, 0, 0);
                            font-weight: normal; color: rgb(0, 0, 0); width: 90px;"></asp:TextBox>
                        <br />
                        <br />
                        CAZ Worse Case Depressurization: Natural:
                        ...
                        <br />
                        Pass?
                        <asp:RadioButton ID="page20_rdo_CAZPass1_Yes" runat="server" GroupName="testgroup20" />Yes
                        <asp:RadioButton ID="page20_rdo_CAZPass1_No" runat="server" GroupName="testgroup20" />No
                        <br />
                        <br />
            ...
            <section id="Form21">
                    <%--Page 21 start--%>
                    <div style="page-break-after: always; border: 1px solid #000000; width: 1020px; margin: 0 auto; position: relative;">
                        <h3>House Air Sealing</h3>
                        <div class="newtable">
                            <table width="100%" border="1" cellspacing="2" cellpadding="2">
                                <tr>
                                    <td></td>
                                    <td></td>
                                    <td align="center">UI/Lin. Ft/#
                                    </td>
                                    <td align="center">Location(s)
                                    </td>
                                    <td align="center">Materials
                                    </td>
                                    <td align="center">Labor Hrs
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txt_DoorWeatherstrip_Location" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_DoorWeatherstrip_Material" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_DoorWeatherstrip_LaborHr" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txt_WindowsReplace_Location" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_WindowsReplace_Material" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txt_WindowsReplace_BrokenGlass_Blank" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_WindowsReplace_BrokenGlass_UI" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_WindowsReplace_BrokenGlass_Location" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_WindowsReplace_BrokenGlass_Material" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_WindowsReplace_BrokenGlass_LaborHr" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txt_WindowsReglaze_Location" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_WindowsReglaze_Material" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txt_WindowsWeatherstrip_Blank" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_WindowsWeatherstrip_UI" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_WindowsWeatherstrip_Location" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_WindowsWeatherstrip_Material" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_WindowsWeatherstrip_LaborHr" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txt_WindowsSashLock_Location" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_WindowsSashLock_Material" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_WindowsSashLock_LaborHr" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txt_WindowsSealing_Location" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_WindowsSealing_Material" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txt_OtherDryerOtherVents_Blank" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_OtherDryerOtherVents_UI" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_OtherDryerOtherVents_Location" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_OtherDryerOtherVents_Material" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_OtherDryerOtherVents_LaborHr" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txt_OtherFireplace_Location" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_OtherFireplace_Material" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txt_OtherElectrical_Location" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_OtherElectrical_Material" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_OtherElectrical_LaborHr" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                        ...
                        <table width="100%" border="1" cellspacing="5" cellpadding="2">
                            <tr>
                                <td align="center" width="35%">Air Sealing Measures:
                                </td>
                                <td align="center" width="50%">Materials
                                </td>
                                <td>Labor hrs Optional
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_AirSealing_TopPlates_Material" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txt_AirSealing_TopPlates_LaborHr" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_AirSealing_Plumbing_Material" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txt_AirSealing_Plumbing_LaborHr" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_AirSealing_Electrical_Material" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txt_AirSealing_Electrical_LaborHr" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_AirSealing_DropCeiling_Material" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txt_AirSealing_DropCeiling_LaborHr" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_AirSealing_BulkheadSoffits_Material" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txt_AirSealing_BulkheadSoffits_LaborHr" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_AirSealing_RecessedFixtures_Material" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txt_AirSealing_RecessedFixtures_LaborHr" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_AirSealing_Access_Material" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txt_AirSealing_Access_LaborHr" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_AirSealing_Ducts_Material" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txt_AirSealing_Ducts_LaborHr" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_AirSealing_AcHtg_Material" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txt_AirSealing_AcHtg_LaborHr" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_AirSealing_OpenChaseways_Material" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="txt_AirSealing_OpenChaseways_LaborHr" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_AirSealing_Other_Material" runat="server" Style="width: 100%; border: none;"></asp:TextBox>
                                </td>
                                <td>
            ...
            <section id="Form22">
                    <%--Page 22 start--%>
                    <div style="border: 1px solid #000000; width: 1020px; margin: 0 auto; position: relative; margin-bottom:200px;">
        ...
        <div class="margindiv">
            ...
            <table width="100%" height="250px" border="1" style="text-align: center">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txt_CustomerSignDateLine4" runat="server" Style="border: 0; width: 100%;                            height: 13px; font-size: 12px;"></asp:TextBox>
                    </td>
                </tr>
            </table>
        </div>
        <p style="padding: 30px 5px;">
            ...
            <div class="tablediv" style="text-align:left; ">
                <div id="one" style="width: 51%; padding-top: 50px; padding-bottom: 50px; float: left;">
                ...
                <div id="two" style="width: 48%; padding-top: 50px; padding-bottom: 50px;  float: left;">
        ...
        <div style="font-weight: bold;">
            ...
            <!-- form section -->
            <div style="border: 1px solid #B3B3B3; width: 1020px; page-break-before: always; margin: 50px auto; position: relative;">
                        ...
                        <td>
                            <div style="float: left; width: 450px; min-height: 300px; margin: 3px;">
                                ...
                                <div style="float: left; padding: 2%; width: 280px; border: 1px dotted #CCC;">
                                    <img src="../NewMETED/Photo_Page_Images1/<%=Convert.ToString(dtPhoto.Rows[i]["PhotoName"])%>"
            ...
            <div style="border: 1px solid #B3B3B3; page-break-before: always; width: 1020px; margin: 0 auto; position: relative;">
                <table border="0" cellpadding="2px;" style="margin: 0 auto; width: 100%;">
                    <%
                        }
                    %>
            ...
            %>
            <br />
            <div style="border-top: 1px solid #cfcfcf; font-size: 14px; color: #717171; padding: 5px 0; text-align: center; width: 1020px; margin: 0 auto; position: relative;">
