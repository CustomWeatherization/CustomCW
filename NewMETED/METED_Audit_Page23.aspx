<%@ Page Language="C#" MasterPageFile="~/NewMETED/METED_Audit_MasterPage.master" AutoEventWireup="true"
    CodeFile="METED_Audit_Page23.aspx.cs" Inherits="METED_METED_Audit_Page21" Title="METED_Audit_Page 21" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
     ...
     $(function() {
            document.getElementById('Page23').classList.add("ui-selected");
        });
