<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManagePrivateEstimate.aspx.cs"
    Inherits="PrivateCustomer_ManagePrivateEstimate" %>
                ...
                <%for (int j = 0; j < dt_1.Rows.Count; j++)
                  {
                      ...
                      {
                          //FinalTotal = Convert.ToDecimal(string.Format("{0:C}", dt_1.Rows[j]["Total"]));
